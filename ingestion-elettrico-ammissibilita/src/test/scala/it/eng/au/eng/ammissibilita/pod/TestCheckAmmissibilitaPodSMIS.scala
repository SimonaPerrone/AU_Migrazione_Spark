package it.eng.au.eng.ammissibilita.pod

//import it.au.misure.cli.FlussoMisureTool
import it.eng.au.ammissibilita.file.CheckAmmissibilitaFile
import it.eng.au.ammissibilita.pod.CheckAmmissibilitaPod.{filenameRegexSMIS, getXMLMetadataSMIS, validate, writeAggregatedPodTxtReport, writeOnHive}
import it.eng.au.ammissibilita.pod.CheckAmmissibilitaPodRulesSMIS
...
@Ignore
class TestCheckAmmissibilitaPodSMIS extends EnvironmentSparkTest {
...
object xmlMeta {
  def fileWithMatches: RDD[XMLMetadata] = {
    val sc = Environment.getSpark.sparkContext
    val SQLContext = Environment.getSpark.sqlContext
