...
import it.eng.au.model.{RuleParameters, XMLMetadata}
...
class TestCheckAmmissibilitaFileRulesSMIS extends EnvironmentSparkTest {
  ...
  def testRulePIVARcuDistr(): Unit = {
    ...
    val xmlWithMetaGood = new XMLMetadata(
      ...
      pivaUDD = "",
      annoMese = "202011",
      listPivaRcuDistr = Environment.getSpark.sparkContext.broadcast(listPivaRcuDistr),
      flusso = "",
      timestamp = "",
      progressivo = "",
      codDp = "",
  ...
  def testRulePIVARcuEmtCodContrDisp(): Unit = {
    ...
    val xmlWithMetaGood = new XMLMetadata(
      ...
      pivaUDD = "01234567890",
      annoMese = "202011",
      listPivaRcuEmt = Environment.getSpark.sparkContext.broadcast(listPivaRcuEmt),
      flusso = "",
      timestamp = "",
      progressivo = "",
      codDp = "",
...
////    val rowsRdd = Environment.getSpark.sparkContext.parallelize(
////      List(
////        ("first", 2.0, 7.0),
////        ("second", 3.5, 2.5),
////        ("third", 7.0, 5.9)
...
//      )
//    )
//    val rowsRdd2 = Environment.getSpark.sparkContext.parallelize(
//      List(
//        ("first", (2.0, 7.0)),
//        ("second", (3.5, 2.5)),
//        ("third", (7.0, 5.9))
