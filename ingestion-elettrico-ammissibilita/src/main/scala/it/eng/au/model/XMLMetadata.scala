...
class XMLMetadata(
                   ...
                   val isPodActiveAtDataMontaggio: Boolean = false
  ...
  override def productElement(n: Int): Any = n match {
    ...
    case 23 => isPodActiveAtDataMontaggio
  }
  ...
  def copy(
            ...
            isPodActiveAtDataMontaggio: Boolean = this.isPodActiveAtDataMontaggio
