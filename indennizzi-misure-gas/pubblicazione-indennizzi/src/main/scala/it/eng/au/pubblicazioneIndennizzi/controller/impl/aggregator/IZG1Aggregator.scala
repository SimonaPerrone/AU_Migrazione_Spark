...
object IZG1Aggregator extends IZGTrait {
  override val keyFields: ListMap[String, String] = ListMap(
    pivaFirst -> IZGOutputSchema.PIVA_ID.toString,
    pivaSecond -> IZGOutputSchema.PIVA_UDD.toString,
    annoMese -> IZGOutputSchema.AAAAMM.toString
  )

  override val flowName: String = "IZG1"
