...
object DettaglioPDRIZG1 extends DettaglioPDRTrait {
  override val keyFields: ListMap[String, String] = ListMap(
    pivaFirst -> DETTAGLIO_PDR_IZGOutputSchema.PIVA_ID.toString,
    pivaSecond -> DETTAGLIO_PDR_IZGOutputSchema.PIVA_UDD.toString,
    annoMese -> DETTAGLIO_PDR_IZGOutputSchema.AAAAMM.toString
  )

  override val flowName: String = "DETTAGLIO_PDR_IZG1"
  override val flowBaseName: String = "CIG1"
  override val baseName: String = "CIG1"
}