...
import it.eng.au.pubblicazioneIndennizzi.controller.impl.aggregator.DettaglioPDRIZG2
import it.eng.au.pubblicazioneIndennizzi.model.DettaglioPDR
import pubblicazioneIndennizzi.EnvironmentSparkTest

class DettaglioPDRIZG2Test extends EnvironmentSparkTest {
  def testAggregatore() : Unit = {
    ...
    DettaglioPDRIZG2.specificRun(df, "")
  }
