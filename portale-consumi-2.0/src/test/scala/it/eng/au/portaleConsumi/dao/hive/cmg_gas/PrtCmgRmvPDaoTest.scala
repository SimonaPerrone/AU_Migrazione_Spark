...
class PrtCmgRmvPDaoTest extends EnvironmentSparkTest {
  val spark = Environment.getSpark
  import spark.implicits._

  case class HiveDaoMock(ds: Dataset[PrtCmgRmvPModel]) extends PrtCmgRmvPDao {
  ...
  def testReadNuoveMisure(): Unit = {
    ...
    val ds = Seq(
      PrtCmgRmvPModel(
        ...
        data_racc = Timestamp.valueOf("2023-01-02 00:00:00"),
        mot_rett_lett = "1",
        let_tot_prel = 0
      ),
      PrtCmgRmvPModel(
    ...
    val expected = MisureGasModel(codice_pdr = "pdr1", lettura = 0, data_lettura = Timestamp.valueOf("2023-01-02 00:00:00"),
      data_caricamento = Timestamp.valueOf("2023-01-02 00:00:00"), annomese = "202001", flusso = "rmv", motivazione = "1")
