...
/*
Dati utente persona fisica + partita iva sotto stesso codice fiscale
 - pdr associato ad una fornitura piva (chiusa) e ora aperta con persona fisica
 - pdr associato a piva (aperta)
 */
object DatiUtente3 {

  val clientefinale: Seq[RcugasClientefinalePModel] = Seq(
    // cliente fisico
    RcugasClientefinalePModel(
      n_id_cliente = "n_id_cliente_Utente3",
      t_codice_fiscale = "t_codice_fiscale_Utente3",
      t_partita_iva = null,
      t_nome = "Utente3",
      t_cognome = "Tre",
    ...
    // piva
    RcugasClientefinalePModel(
      n_id_cliente = "n_id_cliente_Utente3_piva",
      t_codice_fiscale = "t_codice_fiscale_Utente3",
      t_partita_iva = "n_id_cliente_Utente3_piva",
      t_nome = null,
      t_cognome = null,
      d_aggiornamento = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      d_data_rif = Timestamp.valueOf("2021-07-22 00:00:00.0")
  ...
  val residenze: Seq[RcugasResidenzaPModel] = Seq(
    RcugasResidenzaPModel(
      n_id_residenza = "n_id_residenza_Utente1",
      n_id_fornitura = "n_id_fornitura3",
      t_residenza = "SI",
      d_data_inizio = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      d_data_fine = null,
      d_aggiornamento = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      n_id_traccia = "n_id_traccia_Utente3",
      n_id_s_prec = null,
      d_data_rif = Timestamp.valueOf("2021-07-22 00:00:00.0")
    ),
    RcugasResidenzaPModel(
      n_id_residenza = "n_id_residenza_Utente2",
      n_id_fornitura = "n_id_fornitura32",
      t_residenza = "SI",
      d_data_inizio = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      d_data_fine = null,
      d_aggiornamento = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      n_id_traccia = "n_id_traccia_Utente2",
      n_id_s_prec = null,
      d_data_rif = Timestamp.valueOf("2021-07-22 00:00:00.0")
    ),
    RcugasResidenzaPModel(
      n_id_residenza = "n_id_residenza_Utente3",
      n_id_fornitura = "n_id_fornitura33",
      t_residenza = "SI",
      d_data_inizio = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      d_data_fine = null,
      d_aggiornamento = Timestamp.valueOf("2021-07-22 00:00:00.0"),
  ...
  val pdr: Seq[RcugasPdrPModel] = Seq(
    // pdr associato prima a fornitura piva e poi persona fisica
    RcugasPdrPModel(
      n_id_pdr = "n_id_pdr1",
    ...
    // pdr solo partita iva
    RcugasPdrPModel(
      n_id_pdr = "n_id_pdr2",
      t_codice_pdr = "t_codice_pdr2",
      t_cod_tipo_pdr = "0",
      t_codice_istat = "048017",
      t_note = "AggiornaPDR",
      d_aggiornamento = Timestamp.valueOf("2021-07-22 00:00:00.0"),
  ...
  val forniture: Seq[RcugasFornituraPModel] = Seq(
    // fornitura persona fisica aperta su pdr 1
    ...
    // fornitura piva chiusa su pdr 1
    RcugasFornituraPModel(
      n_id_fornitura = "n_id_fornitura32",
      d_data_inizio = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      d_data_fine = Timestamp.valueOf("2021-07-21 00:00:00.0"),
      n_id_cliente = "n_id_cliente_Utente3_piva",
      n_id_pdr = "n_id_pdr1",
      n_id_vend = "n_id_venditore1",
      d_data_stipula = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      d_aggiornamento = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      d_data_rif = Timestamp.valueOf("2021-07-22 00:00:00.0"),
      t_tipo_fornitura = "t_tipo_fornitura1",
      n_indirizzo_fornitura = "n_indirizzo1"
    ),
    // fornitura piva aperta su pdr 2
    RcugasFornituraPModel(
      n_id_fornitura = "n_id_fornitura33",
      d_data_inizio = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      d_data_fine = null,
  ...
  val vulnerabilita: Seq[TdgVulnPModel] = Seq(
    // vulnerabilita' solo su cliente fisico e fornitura aperta
    TdgVulnPModel(
  ...
  val datiprelievo: Seq[RcugasPdrDatiprelievoPModel] = Seq(
    ...
    RcugasPdrDatiprelievoPModel(
      n_id_pdr_datiprelievo = "n_id_pdr_datiprelievo_Pdr32",
      n_id_pdr = "n_id_pdr2",
      t_anno = "2023",
      t_cod_cat_uso = "t_cod_cat_uso_pdr1"
    )
  ...
  val misuratori: Seq[RcugasPdrMisuratorePModel] = Seq(
    ...
    // pdr 2
    RcugasPdrMisuratorePModel(
      n_id_pdr_misuratore = "n_id_pdr_misuratore2",
      n_id_pdr = "n_id_pdr2",
      t_matricola_misuratore = "t_matricola_misuratore2",
      n_coeff_correzione = "0.95",
      t_classe_misuratore = "t_classe_misuratore1",
      t_data_inst_misuratore = Date.valueOf("2022-11-01")
    )
  ...
  val offerte: Seq[RcugasCodiceOffertaPModel] = Seq(
    // offerta fornitura persona fisica aperta
  ...
  val fornituraProcessiGas: Seq[FornitureProcessiGasModel] = Seq(
    ...
    FornitureProcessiGasModel(
      hashcode = null,
      codice_fiscale = "t_codice_fiscale_Utente3",
      ...
      codice_fornitura = "n_id_fornitura3",
    ...
    FornitureProcessiGasModel(
      ...
      nome = null,
      cognome = null,
      p_iva = "n_id_cliente_Utente3_piva",
      ragione_sociale = null,
      cap = "t_cap1",
      categoria_uso = "t_cod_cat_uso_pdr1",
      civico = "t_civico1",
      classe_misuratore = "t_classe_misuratore1",
      codice_fornitura = "n_id_fornitura32",
      coefficiente_conversione = "0.95",
      comune = "t_comune1",
      data_inizio_fornitura = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      data_fine_fornitura = Timestamp.valueOf("2021-07-21 00:00:00.0"),
      data_aggiornamento = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      matricola_misuratore = "t_matricola_misuratore1",
      nazione = "t_nazione1",
      nome_strada = "t_nomestrada1",
      p_iva_cc = "t_piva_Azienda1",
    ...
    // fornitura aperta chiusa su pdr 2
    FornitureProcessiGasModel(
      hashcode = null,
      codice_fiscale = "t_codice_fiscale_Utente3",
      ...
      civico = "t_civico1",
      classe_misuratore = "t_classe_misuratore1",
      codice_fornitura = "n_id_fornitura33",
      coefficiente_conversione = "0.95",
      comune = "t_comune1",
      data_inizio_fornitura = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      data_fine_fornitura = null,
      data_aggiornamento = Timestamp.valueOf("2020-07-22 00:00:00.0"),
      matricola_misuratore = "t_matricola_misuratore2",
      nazione = "t_nazione1",
      nome_strada = "t_nomestrada1",
      p_iva_cc = "t_piva_Azienda1",
      provincia = "t_provincia1",
