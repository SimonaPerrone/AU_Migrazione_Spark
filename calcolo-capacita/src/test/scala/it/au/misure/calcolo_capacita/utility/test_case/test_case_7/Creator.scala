package it.au.misure.calcolo_capacita.utility.test_case.test_case_7
 ...
 override def getAnagrafica(implicit sqlContext: SQLContext): DataFrame = {
  import sqlContext.implicits._
   ...
   Seq(
     ...
     ("IDPDR3","2020-12-12 fixme",na,"PDR4",31.1,11.0,10.0,"A"),
     ("IDPDR3","2020-12-12 fixme",na,"PDR5",31.1,11.0,10.0,"A"),
     ("IDPDR3","2020-12-12 fixme",na,"PDR7",31.1,11.0,10.0,"A")
