package it.au.misure.calcolo_capacita.utility.test_case.test_case_5
...
case class Creator() extends it.au.misure.calcolo_capacita.utility.test_case.Creator {
  ...
  override def getAnagrafica(implicit sqlContext: SQLContext): DataFrame = {
    ...
    Seq(
      ...
      ("IDPDR3", "2020-12-12 fixme", na, "PDR3", 29.0, 0.0, 0.0, "A"),
      ("IDPDR4", "2020-12-12 fixme", na, "PDR4", 28.0, 0.0, 0.0, "A"),
      ("IDPDR5", "2020-12-12 fixme", na, "PDR5", 28.0, 0.0, 0.0, "A")
    )
