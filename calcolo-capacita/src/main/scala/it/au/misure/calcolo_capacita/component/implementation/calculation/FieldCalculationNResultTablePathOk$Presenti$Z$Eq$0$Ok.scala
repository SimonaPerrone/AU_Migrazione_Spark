...
import it.au.misure.calcolo_capacita.component.utility.ApplicationConstant.OK
import it.au.misure.calcolo_capacita.component.utility.check.Args
import org.apache.spark.sql.DataFrame
import org.apache.spark.sql.functions.lit
import org.apache.spark.sql.types.StringType

object FieldCalculationNResultTablePathOk$Presenti$Z$Eq$0$Ok extends FieldCalculationNResultTable {
  ...
  override protected def calculation(dataFrame: DataFrame)(implicit args: Args): DataFrame = {
    ...
    dataFrame_v2
      ...
      .withColumn(ClgPdrCapacitaSchema.t_esito_code_desc, lit(nullCol))
