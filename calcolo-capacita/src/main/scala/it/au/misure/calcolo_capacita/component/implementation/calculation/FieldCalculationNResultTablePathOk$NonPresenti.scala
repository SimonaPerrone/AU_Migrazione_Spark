...
import it.au.misure.calcolo_capacita.component.utility.ApplicationConstant.{OK, WARN_MISURE}
import it.au.misure.calcolo_capacita.component.utility.check.Args
import org.apache.spark.sql.DataFrame
import org.apache.spark.sql.functions.lit

object FieldCalculationNResultTablePathOk$NonPresenti extends FieldCalculationNResultTable {
  ...
  override protected def calculation(dataFrame: DataFrame)(implicit args: Args): DataFrame = {
    ...
    dataFrame_v2
      ...
      .withColumn(ClgPdrCapacitaSchema.t_esito_code_desc, lit(WARN_MISURE))
