...
class TalDAOTest extends EnvironmentSparkTest {
  def testGet(): Unit = {
...
//    Assert.assertEquals(1, result.filter(_.pdr == "8").count)
  }

  object TalDAOMock extends TalDAOSbg {
    override def readParquet: DataFrame = {
      val sqlContext = Environment.getSpark
    import sqlContext.implicits._

      List(
        ("TAL", "1", "30/11/2021", "30/11/2021", "000010343", "null", "27545059", "null",
        ...
        ("TAL", "2", "31/05/2019", "31/05/2019", "000003233", "null", "0084966131", "null",
        ...
        ("TAL", "3", "28/05/2019", "28/05/2019", "000004300", "null", "ITGF030001789664", "null",
