...
class TasDAOTest extends EnvironmentSparkTest {
  def testGet(): Unit = {
    ...
    Assert.assertEquals(1, result.filter(_.pdr == "5").count)
  ...
  object TasDAOMock extends TasDAOSbg {
    ...
    import sqlContext.implicits._
      ...
      List(
        ...
        ("TAS", "2", "02/02/2022", "02/02/2022", "000000967", "null", "0000486011", "null",
