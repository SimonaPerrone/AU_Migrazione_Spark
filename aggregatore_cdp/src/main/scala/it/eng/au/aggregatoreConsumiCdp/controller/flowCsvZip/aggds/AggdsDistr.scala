...
import it.eng.au.aggregatoreConsumiCdp.controller.flowCsvZip.traits.Aggds
...
object AggdsDistr extends Aggds {
  ...
  override def fileSpecificFilterExpression: Column = col(OutputCsvSchema.piva_distr).isNotNull && col(OutputCsvSchema.piva_udd).isNotNull
