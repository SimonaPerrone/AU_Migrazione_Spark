# STEP 1: MIGRAZIONE ARCHITETTURALE aggiustamento-gas
...
|---|---|---|---|
| **UnzipDriver** | YARN + NFS | YARN + HDFS Gateway + Kerberos | `spark-submit-aggiustamento-gas-unzip.sh` |
| **FlowDriver** | YARN + NFS | CDE + HDFS + Kerberos | `spark-submit-aggiustamento-gas-ingestion.sh` |
| **Autenticazione** | — | `kinit` (Kerberos) | Aggiungi agli script |
| **Path Input** | `/mnt/isilonshare_aggiustamento-gas` | `/mnt/hdfs-gateway/aggiustamento-gas/input` | `config.properties` |
| **Path Temp** | `/mnt/isilonshare1/aggiustamento-gas_INJ_STD/...` | `/mnt/hdfs-gateway/aggiustamento-gas/temp` | `config.properties` |
...
### A1. `spark-submit-aggiustamento-gas-unzip.sh` - YARN Decompression
...
spark2-submit \
    --class it.au.aggiustamento-gas.driver.UnzipDriver \
    --master yarn \
    ... (resto invariato)
A2. spark-submit-aggiustamento-gas-ingestion.sh - CDE Calcolo
bash
...
spark2-submit --master yarn \
    --class it.au.aggiustamento-gas.driver.FlowDriver \
    ... (resto invariato)
...
# Input paths
unzip.input.path=/mnt/hdfs-gateway/aggiustamento-gas/input
# PRIMA: /mnt/isilonshare_aggiustamento-gas

# Temp paths
temp.path=/mnt/hdfs-gateway/aggiustamento-gas/temp
# PRIMA: /mnt/isilonshare1/aggiustamento-gas_INJ_STD/isilonshare_aggiustamento-gas

temp.path.old=/mnt/hdfs-gateway/aggiustamento-gas/temp_old
# PRIMA: /mnt/isilonshare1/aggiustamento-gas_INJ/isilonshare_aggiustamento-gas

# XSD e config
xsd.path=/mnt/hdfs-gateway/aggiustamento-gas/xsd
# PRIMA: /mnt/isilonshare1/XSD_aggiustamento-gas_STANDARD

# Validation/reports
ammissibilita.standard.path=/mnt/hdfs-gateway/aggiustamento-gas/ammissibilita
# PRIMA: /mnt/isilonshare1/TMG_SYNC_TMP1

# Deploy
deploy.path=/mnt/hdfs-gateway/aggiustamento-gas/deploy
# PRIMA: /mnt/isilonshare1/Software/aggiustamento-gas/STANDARD
...
rootPath=/mnt/hdfs-gateway/aggiustamento-gas/ingestion
# PRIMA: /mnt/isilonshare1/aggiustamento-gas_INJ_STD/...

tempRootPath=/mnt/hdfs-gateway/aggiustamento-gas/temp
# PRIMA: /mnt/isilonshare1/aggiustamento-gas_INJ_STD/...
...
Gateway Access	ls /mnt/hdfs-gateway/aggiustamento-gas/input/	Directory listing OK
Write Access	touch /mnt/hdfs-gateway/aggiustamento-gas/temp/test.txt && rm test.txt	File created/deleted
UnzipDriver	bash spark-submit-aggiustamento-gas-unzip.sh --input=sample.zip	Job SUCCEEDED
FlowDriver	bash spark-submit-aggiustamento-gas-ingestion.sh --input=unzipped/	Job SUCCEEDED
...
CODE
  ☐ Modifica spark-submit-aggiustamento-gas-unzip.sh con kinit
  ☐ Modifica spark-submit-aggiustamento-gas-ingestion.sh con kinit
...
2	Script Unzip	Add kinit + test	spark-submit-aggiustamento-gas-unzip.sh	☐
3	Script Flow	Add kinit/CDE + test	spark-submit-aggiustamento-gas-ingestion.sh	☐
...
I. NOTE IMPORTANTI
Path mapping: ogni occorrenza di /mnt/isilonshare* → /mnt/hdfs-gateway/aggiustamento-gas/*
...
Directory ownership: /mnt/hdfs-gateway/aggiustamento-gas/* → deve essere writable da airflow
