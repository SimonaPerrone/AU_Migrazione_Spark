# STEP 1: MIGRAZIONE ARCHITETTURALE portale-consumi-2.0
...
|---|---|---|---|
| **UnzipDriver** | YARN + NFS | YARN + HDFS Gateway + Kerberos | `spark-submit-portale-consumi-2.0-unzip.sh` |
| **FlowDriver** | YARN + NFS | CDE + HDFS + Kerberos | `spark-submit-portale-consumi-2.0-ingestion.sh` |
| **Autenticazione** | — | `kinit` (Kerberos) | Aggiungi agli script |
| **Path Input** | `/mnt/isilonshare_portale-consumi-2.0` | `/mnt/hdfs-gateway/portale-consumi-2.0/input` | `config.properties` |
| **Path Temp** | `/mnt/isilonshare1/portale-consumi-2.0_INJ_STD/...` | `/mnt/hdfs-gateway/portale-consumi-2.0/temp` | `config.properties` |
...
### A1. `spark-submit-portale-consumi-2.0-unzip.sh` - YARN Decompression
...
spark2-submit \
    --class it.au.portale-consumi-2.0.driver.UnzipDriver \
    --master yarn \
    ... (resto invariato)
A2. spark-submit-portale-consumi-2.0-ingestion.sh - CDE Calcolo
bash
...
spark2-submit --master yarn \
    --class it.au.portale-consumi-2.0.driver.FlowDriver \
    ... (resto invariato)
...
# Input paths
unzip.input.path=/mnt/hdfs-gateway/portale-consumi-2.0/input
# PRIMA: /mnt/isilonshare_portale-consumi-2.0

# Temp paths
temp.path=/mnt/hdfs-gateway/portale-consumi-2.0/temp
# PRIMA: /mnt/isilonshare1/portale-consumi-2.0_INJ_STD/isilonshare_portale-consumi-2.0

temp.path.old=/mnt/hdfs-gateway/portale-consumi-2.0/temp_old
# PRIMA: /mnt/isilonshare1/portale-consumi-2.0_INJ/isilonshare_portale-consumi-2.0

# XSD e config
xsd.path=/mnt/hdfs-gateway/portale-consumi-2.0/xsd
# PRIMA: /mnt/isilonshare1/XSD_portale-consumi-2.0_STANDARD

# Validation/reports
ammissibilita.standard.path=/mnt/hdfs-gateway/portale-consumi-2.0/ammissibilita
# PRIMA: /mnt/isilonshare1/TMG_SYNC_TMP1

# Deploy
deploy.path=/mnt/hdfs-gateway/portale-consumi-2.0/deploy
# PRIMA: /mnt/isilonshare1/Software/portale-consumi-2.0/STANDARD
...
rootPath=/mnt/hdfs-gateway/portale-consumi-2.0/ingestion
# PRIMA: /mnt/isilonshare1/portale-consumi-2.0_INJ_STD/...

tempRootPath=/mnt/hdfs-gateway/portale-consumi-2.0/temp
# PRIMA: /mnt/isilonshare1/portale-consumi-2.0_INJ_STD/...
...
Gateway Access	ls /mnt/hdfs-gateway/portale-consumi-2.0/input/	Directory listing OK
Write Access	touch /mnt/hdfs-gateway/portale-consumi-2.0/temp/test.txt && rm test.txt	File created/deleted
UnzipDriver	bash spark-submit-portale-consumi-2.0-unzip.sh --input=sample.zip	Job SUCCEEDED
FlowDriver	bash spark-submit-portale-consumi-2.0-ingestion.sh --input=unzipped/	Job SUCCEEDED
...
CODE
  ☐ Modifica spark-submit-portale-consumi-2.0-unzip.sh con kinit
  ☐ Modifica spark-submit-portale-consumi-2.0-ingestion.sh con kinit
...
2	Script Unzip	Add kinit + test	spark-submit-portale-consumi-2.0-unzip.sh	☐
3	Script Flow	Add kinit/CDE + test	spark-submit-portale-consumi-2.0-ingestion.sh	☐
...
I. NOTE IMPORTANTI
Path mapping: ogni occorrenza di /mnt/isilonshare* → /mnt/hdfs-gateway/portale-consumi-2.0/*
...
Directory ownership: /mnt/hdfs-gateway/portale-consumi-2.0/* → deve essere writable da airflow
