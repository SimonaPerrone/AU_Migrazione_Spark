# STEP 1: MIGRAZIONE ARCHITETTURALE cdp-codprofstd-tds
...
|---|---|---|---|
| **UnzipDriver** | YARN + NFS | YARN + HDFS Gateway + Kerberos | `spark-submit-cdp-codprofstd-tds-unzip.sh` |
| **FlowDriver** | YARN + NFS | CDE + HDFS + Kerberos | `spark-submit-cdp-codprofstd-tds-ingestion.sh` |
| **Autenticazione** | — | `kinit` (Kerberos) | Aggiungi agli script |
| **Path Input** | `/mnt/isilonshare_cdp-codprofstd-tds` | `/mnt/hdfs-gateway/cdp-codprofstd-tds/input` | `config.properties` |
| **Path Temp** | `/mnt/isilonshare1/cdp-codprofstd-tds_INJ_STD/...` | `/mnt/hdfs-gateway/cdp-codprofstd-tds/temp` | `config.properties` |
...
### A1. `spark-submit-cdp-codprofstd-tds-unzip.sh` - YARN Decompression
...
spark2-submit \
    --class it.au.cdp-codprofstd-tds.driver.UnzipDriver \
    --master yarn \
    ... (resto invariato)
A2. spark-submit-cdp-codprofstd-tds-ingestion.sh - CDE Calcolo
bash
...
spark2-submit --master yarn \
    --class it.au.cdp-codprofstd-tds.driver.FlowDriver \
    ... (resto invariato)
...
# Input paths
unzip.input.path=/mnt/hdfs-gateway/cdp-codprofstd-tds/input
# PRIMA: /mnt/isilonshare_cdp-codprofstd-tds

# Temp paths
temp.path=/mnt/hdfs-gateway/cdp-codprofstd-tds/temp
# PRIMA: /mnt/isilonshare1/cdp-codprofstd-tds_INJ_STD/isilonshare_cdp-codprofstd-tds

temp.path.old=/mnt/hdfs-gateway/cdp-codprofstd-tds/temp_old
# PRIMA: /mnt/isilonshare1/cdp-codprofstd-tds_INJ/isilonshare_cdp-codprofstd-tds

# XSD e config
xsd.path=/mnt/hdfs-gateway/cdp-codprofstd-tds/xsd
# PRIMA: /mnt/isilonshare1/XSD_cdp-codprofstd-tds_STANDARD

# Validation/reports
ammissibilita.standard.path=/mnt/hdfs-gateway/cdp-codprofstd-tds/ammissibilita
# PRIMA: /mnt/isilonshare1/TMG_SYNC_TMP1

# Deploy
deploy.path=/mnt/hdfs-gateway/cdp-codprofstd-tds/deploy
# PRIMA: /mnt/isilonshare1/Software/cdp-codprofstd-tds/STANDARD
...
rootPath=/mnt/hdfs-gateway/cdp-codprofstd-tds/ingestion
# PRIMA: /mnt/isilonshare1/cdp-codprofstd-tds_INJ_STD/...

tempRootPath=/mnt/hdfs-gateway/cdp-codprofstd-tds/temp
# PRIMA: /mnt/isilonshare1/cdp-codprofstd-tds_INJ_STD/...
...
Gateway Access	ls /mnt/hdfs-gateway/cdp-codprofstd-tds/input/	Directory listing OK
Write Access	touch /mnt/hdfs-gateway/cdp-codprofstd-tds/temp/test.txt && rm test.txt	File created/deleted
UnzipDriver	bash spark-submit-cdp-codprofstd-tds-unzip.sh --input=sample.zip	Job SUCCEEDED
FlowDriver	bash spark-submit-cdp-codprofstd-tds-ingestion.sh --input=unzipped/	Job SUCCEEDED
...
CODE
  ☐ Modifica spark-submit-cdp-codprofstd-tds-unzip.sh con kinit
  ☐ Modifica spark-submit-cdp-codprofstd-tds-ingestion.sh con kinit
...
2	Script Unzip	Add kinit + test	spark-submit-cdp-codprofstd-tds-unzip.sh	☐
3	Script Flow	Add kinit/CDE + test	spark-submit-cdp-codprofstd-tds-ingestion.sh	☐
...
I. NOTE IMPORTANTI
Path mapping: ogni occorrenza di /mnt/isilonshare* → /mnt/hdfs-gateway/cdp-codprofstd-tds/*
...
Directory ownership: /mnt/hdfs-gateway/cdp-codprofstd-tds/* → deve essere writable da airflow
