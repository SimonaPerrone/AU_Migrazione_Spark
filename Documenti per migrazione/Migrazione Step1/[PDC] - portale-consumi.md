# STEP 1: MIGRAZIONE ARCHITETTURALE portale-consumi
...
|---|---|---|---|
| **UnzipDriver** | YARN + NFS | YARN + HDFS Gateway + Kerberos | `spark-submit-portale-consumi-unzip.sh` |
| **FlowDriver** | YARN + NFS | CDE + HDFS + Kerberos | `spark-submit-portale-consumi-ingestion.sh` |
| **Autenticazione** | — | `kinit` (Kerberos) | Aggiungi agli script |
| **Path Input** | `/mnt/isilonshare_portale-consumi` | `/mnt/hdfs-gateway/portale-consumi/input` | `config.properties` |
| **Path Temp** | `/mnt/isilonshare1/portale-consumi_INJ_STD/...` | `/mnt/hdfs-gateway/portale-consumi/temp` | `config.properties` |
...
### A1. `spark-submit-portale-consumi-unzip.sh` - YARN Decompression
...
spark2-submit \
    --class it.au.portale-consumi.driver.UnzipDriver \
    --master yarn \
    ... (resto invariato)
A2. spark-submit-portale-consumi-ingestion.sh - CDE Calcolo
bash
...
spark2-submit --master yarn \
    --class it.au.portale-consumi.driver.FlowDriver \
    ... (resto invariato)
...
# Input paths
unzip.input.path=/mnt/hdfs-gateway/portale-consumi/input
# PRIMA: /mnt/isilonshare_portale-consumi

# Temp paths
temp.path=/mnt/hdfs-gateway/portale-consumi/temp
# PRIMA: /mnt/isilonshare1/portale-consumi_INJ_STD/isilonshare_portale-consumi

temp.path.old=/mnt/hdfs-gateway/portale-consumi/temp_old
# PRIMA: /mnt/isilonshare1/portale-consumi_INJ/isilonshare_portale-consumi

# XSD e config
xsd.path=/mnt/hdfs-gateway/portale-consumi/xsd
# PRIMA: /mnt/isilonshare1/XSD_portale-consumi_STANDARD

# Validation/reports
ammissibilita.standard.path=/mnt/hdfs-gateway/portale-consumi/ammissibilita
# PRIMA: /mnt/isilonshare1/TMG_SYNC_TMP1

# Deploy
deploy.path=/mnt/hdfs-gateway/portale-consumi/deploy
# PRIMA: /mnt/isilonshare1/Software/portale-consumi/STANDARD
...
rootPath=/mnt/hdfs-gateway/portale-consumi/ingestion
# PRIMA: /mnt/isilonshare1/portale-consumi_INJ_STD/...

tempRootPath=/mnt/hdfs-gateway/portale-consumi/temp
# PRIMA: /mnt/isilonshare1/portale-consumi_INJ_STD/...
...
Gateway Access	ls /mnt/hdfs-gateway/portale-consumi/input/	Directory listing OK
Write Access	touch /mnt/hdfs-gateway/portale-consumi/temp/test.txt && rm test.txt	File created/deleted
UnzipDriver	bash spark-submit-portale-consumi-unzip.sh --input=sample.zip	Job SUCCEEDED
FlowDriver	bash spark-submit-portale-consumi-ingestion.sh --input=unzipped/	Job SUCCEEDED
...
CODE
  ☐ Modifica spark-submit-portale-consumi-unzip.sh con kinit
  ☐ Modifica spark-submit-portale-consumi-ingestion.sh con kinit
...
2	Script Unzip	Add kinit + test	spark-submit-portale-consumi-unzip.sh	☐
3	Script Flow	Add kinit/CDE + test	spark-submit-portale-consumi-ingestion.sh	☐
...
I. NOTE IMPORTANTI
Path mapping: ogni occorrenza di /mnt/isilonshare* → /mnt/hdfs-gateway/portale-consumi/*
...
Directory ownership: /mnt/hdfs-gateway/portale-consumi/* → deve essere writable da airflow
