# STEP 1: MIGRAZIONE ARCHITETTURALE portale-consumi-ee
...
|---|---|---|---|
| **UnzipDriver** | YARN + NFS | YARN + HDFS Gateway + Kerberos | `spark-submit-portale-consumi-ee-unzip.sh` |
| **FlowDriver** | YARN + NFS | CDE + HDFS + Kerberos | `spark-submit-portale-consumi-ee-ingestion.sh` |
| **Autenticazione** | — | `kinit` (Kerberos) | Aggiungi agli script |
| **Path Input** | `/mnt/isilonshare_portale-consumi-ee` | `/mnt/hdfs-gateway/portale-consumi-ee/input` | `config.properties` |
| **Path Temp** | `/mnt/isilonshare1/portale-consumi-ee_INJ_STD/...` | `/mnt/hdfs-gateway/portale-consumi-ee/temp` | `config.properties` |
...
### A1. `spark-submit-portale-consumi-ee-unzip.sh` - YARN Decompression
...
spark2-submit \
    --class it.au.portale-consumi-ee.driver.UnzipDriver \
    --master yarn \
    ... (resto invariato)
A2. spark-submit-portale-consumi-ee-ingestion.sh - CDE Calcolo
bash
...
spark2-submit --master yarn \
    --class it.au.portale-consumi-ee.driver.FlowDriver \
    ... (resto invariato)
...
# Input paths
unzip.input.path=/mnt/hdfs-gateway/portale-consumi-ee/input
# PRIMA: /mnt/isilonshare_portale-consumi-ee

# Temp paths
temp.path=/mnt/hdfs-gateway/portale-consumi-ee/temp
# PRIMA: /mnt/isilonshare1/portale-consumi-ee_INJ_STD/isilonshare_portale-consumi-ee

temp.path.old=/mnt/hdfs-gateway/portale-consumi-ee/temp_old
# PRIMA: /mnt/isilonshare1/portale-consumi-ee_INJ/isilonshare_portale-consumi-ee

# XSD e config
xsd.path=/mnt/hdfs-gateway/portale-consumi-ee/xsd
# PRIMA: /mnt/isilonshare1/XSD_portale-consumi-ee_STANDARD

# Validation/reports
ammissibilita.standard.path=/mnt/hdfs-gateway/portale-consumi-ee/ammissibilita
# PRIMA: /mnt/isilonshare1/TMG_SYNC_TMP1

# Deploy
deploy.path=/mnt/hdfs-gateway/portale-consumi-ee/deploy
# PRIMA: /mnt/isilonshare1/Software/portale-consumi-ee/STANDARD
...
rootPath=/mnt/hdfs-gateway/portale-consumi-ee/ingestion
# PRIMA: /mnt/isilonshare1/portale-consumi-ee_INJ_STD/...

tempRootPath=/mnt/hdfs-gateway/portale-consumi-ee/temp
# PRIMA: /mnt/isilonshare1/portale-consumi-ee_INJ_STD/...
...
Gateway Access	ls /mnt/hdfs-gateway/portale-consumi-ee/input/	Directory listing OK
Write Access	touch /mnt/hdfs-gateway/portale-consumi-ee/temp/test.txt && rm test.txt	File created/deleted
UnzipDriver	bash spark-submit-portale-consumi-ee-unzip.sh --input=sample.zip	Job SUCCEEDED
FlowDriver	bash spark-submit-portale-consumi-ee-ingestion.sh --input=unzipped/	Job SUCCEEDED
...
CODE
  ☐ Modifica spark-submit-portale-consumi-ee-unzip.sh con kinit
  ☐ Modifica spark-submit-portale-consumi-ee-ingestion.sh con kinit
...
2	Script Unzip	Add kinit + test	spark-submit-portale-consumi-ee-unzip.sh	☐
3	Script Flow	Add kinit/CDE + test	spark-submit-portale-consumi-ee-ingestion.sh	☐
...
I. NOTE IMPORTANTI
Path mapping: ogni occorrenza di /mnt/isilonshare* → /mnt/hdfs-gateway/portale-consumi-ee/*
...
Directory ownership: /mnt/hdfs-gateway/portale-consumi-ee/* → deve essere writable da airflow
