# STEP 1: MIGRAZIONE ARCHITETTURALE meccanismo-incentivante-distributori-gas
...
|---|---|---|---|
| **UnzipDriver** | YARN + NFS | YARN + HDFS Gateway + Kerberos | `spark-submit-meccanismo-incentivante-distributori-gas-unzip.sh` |
| **FlowDriver** | YARN + NFS | CDE + HDFS + Kerberos | `spark-submit-meccanismo-incentivante-distributori-gas-ingestion.sh` |
| **Autenticazione** | — | `kinit` (Kerberos) | Aggiungi agli script |
| **Path Input** | `/mnt/isilonshare_meccanismo-incentivante-distributori-gas` | `/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/input` | `config.properties` |
| **Path Temp** | `/mnt/isilonshare1/meccanismo-incentivante-distributori-gas_INJ_STD/...` | `/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/temp` | `config.properties` |
...
### A1. `spark-submit-meccanismo-incentivante-distributori-gas-unzip.sh` - YARN Decompression
...
spark2-submit \
    --class it.au.meccanismo-incentivante-distributori-gas.driver.UnzipDriver \
    --master yarn \
    ... (resto invariato)
A2. spark-submit-meccanismo-incentivante-distributori-gas-ingestion.sh - CDE Calcolo
bash
...
spark2-submit --master yarn \
    --class it.au.meccanismo-incentivante-distributori-gas.driver.FlowDriver \
    ... (resto invariato)
...
# Input paths
unzip.input.path=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/input
# PRIMA: /mnt/isilonshare_meccanismo-incentivante-distributori-gas

# Temp paths
temp.path=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/temp
# PRIMA: /mnt/isilonshare1/meccanismo-incentivante-distributori-gas_INJ_STD/isilonshare_meccanismo-incentivante-distributori-gas

temp.path.old=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/temp_old
# PRIMA: /mnt/isilonshare1/meccanismo-incentivante-distributori-gas_INJ/isilonshare_meccanismo-incentivante-distributori-gas

# XSD e config
xsd.path=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/xsd
# PRIMA: /mnt/isilonshare1/XSD_meccanismo-incentivante-distributori-gas_STANDARD

# Validation/reports
ammissibilita.standard.path=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/ammissibilita
# PRIMA: /mnt/isilonshare1/TMG_SYNC_TMP1

# Deploy
deploy.path=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/deploy
# PRIMA: /mnt/isilonshare1/Software/meccanismo-incentivante-distributori-gas/STANDARD
...
rootPath=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/ingestion
# PRIMA: /mnt/isilonshare1/meccanismo-incentivante-distributori-gas_INJ_STD/...

tempRootPath=/mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/temp
# PRIMA: /mnt/isilonshare1/meccanismo-incentivante-distributori-gas_INJ_STD/...
...
Gateway Access	ls /mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/input/	Directory listing OK
Write Access	touch /mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/temp/test.txt && rm test.txt	File created/deleted
UnzipDriver	bash spark-submit-meccanismo-incentivante-distributori-gas-unzip.sh --input=sample.zip	Job SUCCEEDED
FlowDriver	bash spark-submit-meccanismo-incentivante-distributori-gas-ingestion.sh --input=unzipped/	Job SUCCEEDED
...
CODE
  ☐ Modifica spark-submit-meccanismo-incentivante-distributori-gas-unzip.sh con kinit
  ☐ Modifica spark-submit-meccanismo-incentivante-distributori-gas-ingestion.sh con kinit
...
2	Script Unzip	Add kinit + test	spark-submit-meccanismo-incentivante-distributori-gas-unzip.sh	☐
3	Script Flow	Add kinit/CDE + test	spark-submit-meccanismo-incentivante-distributori-gas-ingestion.sh	☐
...
I. NOTE IMPORTANTI
Path mapping: ogni occorrenza di /mnt/isilonshare* → /mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/*
...
Directory ownership: /mnt/hdfs-gateway/meccanismo-incentivante-distributori-gas/* → deve essere writable da airflow
