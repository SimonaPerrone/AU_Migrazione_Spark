...
object ValidateFileIGMR extends ValidateFile{
  ...
  override val checkAmm = new CheckAmmissibilitaFileRulesIGMR
  override val ammissibilitaFolder: String = PropertyUtility.getAmmissibilitaIgmrPath
}
