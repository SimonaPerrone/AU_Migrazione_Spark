...
#            sort ${base_folder}/${REPORT_FILE_IGMG_NAME}*.txt > "${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
#            sed -i "/${CSV_HEADER_FILE}/d" "${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
#            sed -i 1i\ "$(echo ${CSV_HEADER_FILE})" "${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
#            cat "${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt" > "${destination_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
          else
...
#            cat ${base_folder}/${REPORT_FILE_IGMG_NAME}*.txt > "${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
#            sed -i "/${CSV_HEADER_FILE}/d" "${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
#            sort ${last_report_in_output_dir_file_igmg} ${tmp_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt \
#                    > "${destination_folder}/${REPORT_FILE_IGMG_NAME}_${CURTMS}.txt"
          fi
...
#            sort ${base_folder}/${REPORT_FILE_STANDARD_NAME}*.txt > "${tmp_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
#            sed -i "/${CSV_HEADER_FILE}/d" "${tmp_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
#            sed -i 1i\ "$(echo ${CSV_HEADER_FILE})" "${tmp_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
#            cat "${tmp_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt" > "${destination_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
          else
...
#            cat ${base_folder}/${REPORT_FILE_STANDARD_NAME}*.txt > "${tmp_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
#            sed -i "/${CSV_HEADER_FILE}/d" "${tmp_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
#            sort ${last_report_in_output_dir_file_std} ${base_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt \
#                    > "${destination_folder}/${REPORT_FILE_STANDARD_NAME}_${CURTMS}.txt"
          fi
    ...
    if [[ "${REPORT_PDR}" == "true" ]]; then
      ...
      if [[ igmg_num -gt 0 ]]; then
          ...
          if [[ reports_in_output_dir_pdr_igmg -eq 0 ]]; then
              sed -i 1i\ "$(echo ${CSV_HEADER_PDR})" "${tmp_folder}/TMP_aggregazione_IGMG.txt"
              sort "${tmp_folder}/TMP_aggregazione_IGMG.txt" > "${destination_folder}/${REPORT_PDR_IGMG_NAME}_${CURTMS}.txt"
          else
              local last_report_in_output_dir_pdr_igmg=$(find "${destination_folder}" -type f -name "${REPORT_PDR_IGMG_NAME}_*.txt" | sort -n | tail -1)
              sort ${last_report_in_output_dir_pdr_igmg} "${tmp_folder}/TMP_aggregazione_IGMG.txt" \
                    > "${destination_folder}/${REPORT_PDR_IGMG_NAME}_${CURTMS}.txt"
#              sort ${destination_folder}/${REPORT_PDR_IGMG_NAME}_*.txt "${tmp_folder}/TMP_aggregazione_IGMG.txt" \
#                    > "${destination_folder}/${REPORT_PDR_IGMG_NAME}_${CURTMS}.txt"
          fi
      ...
      if [[ std_num -gt 0 ]]; then
          ...
          if [[ reports_in_output_dir_pdr_std -eq 0 ]]; then
              sed -i 1i\ "$(echo ${CSV_HEADER_PDR})" "${tmp_folder}/TMP_Aggregazione_STD.txt"
              sort "${tmp_folder}/TMP_Aggregazione_STD.txt" > "${destination_folder}/${REPORT_PDR_STANDARD_NAME}_${CURTMS}.txt"
          else
              local last_report_in_output_dir_pdr_std=$(find "${destination_folder}" -type f -name "${REPORT_PDR_STANDARD_NAME}_*.txt" | sort -n | tail -1)
              sort ${last_report_in_output_dir_pdr_std} "${tmp_folder}/TMP_Aggregazione_STD.txt" \
                    > "${destination_folder}/${REPORT_PDR_STANDARD_NAME}_${CURTMS}.txt"
#              sort ${destination_folder}/${REPORT_PDR_STANDARD_NAME}_*.txt "${tmp_folder}/TMP_Aggregazione_STD.txt" \
#                    > "${destination_folder}/${REPORT_PDR_STANDARD_NAME}_${CURTMS}.txt"
          fi
