// ORM class for table 'RCUGAS.RCUGAS_BILANCIAMENTO'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Dec 21 07:30:16 CET 2019
...
public class RCUGAS_RCUGAS_BILANCIAMENTO extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  public static interface FieldSetterCommand {    void setField(Object value);  }  protected ResultSet __cur_result_set;
  private Map<String, FieldSetterCommand> setters = new HashMap<String, FieldSetterCommand>();
  private void init0() {
    setters.put("N_ID_BILANCIAMENTO", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        N_ID_BILANCIAMENTO = (java.math.BigDecimal)value;
      }
    });
    setters.put("N_ID_UDB", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        N_ID_UDB = (java.math.BigDecimal)value;
      }
    });
    ...
    setters.put("T_TIPO_BILANCIAMENTO", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T_TIPO_BILANCIAMENTO = (String)value;
      }
    });
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO() {
    init0();
  }
  private java.math.BigDecimal N_ID_BILANCIAMENTO;
  public java.math.BigDecimal get_N_ID_BILANCIAMENTO() {
    return N_ID_BILANCIAMENTO;
  }
  public void set_N_ID_BILANCIAMENTO(java.math.BigDecimal N_ID_BILANCIAMENTO) {
    this.N_ID_BILANCIAMENTO = N_ID_BILANCIAMENTO;
  }
  public RCUGAS_RCUGAS_BILANCIAMENTO with_N_ID_BILANCIAMENTO(java.math.BigDecimal N_ID_BILANCIAMENTO) {
    this.N_ID_BILANCIAMENTO = N_ID_BILANCIAMENTO;
    return this;
  }
  private java.math.BigDecimal N_ID_UDB;
  public java.math.BigDecimal get_N_ID_UDB() {
    return N_ID_UDB;
  }
  public void set_N_ID_UDB(java.math.BigDecimal N_ID_UDB) {
    this.N_ID_UDB = N_ID_UDB;
  }
  public RCUGAS_RCUGAS_BILANCIAMENTO with_N_ID_UDB(java.math.BigDecimal N_ID_UDB) {
    this.N_ID_UDB = N_ID_UDB;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_N_ID_PDR(java.math.BigDecimal N_ID_PDR) {
    this.N_ID_PDR = N_ID_PDR;
    return this;
  }
  private String T_TIPO_BILANCIAMENTO;
  public String get_T_TIPO_BILANCIAMENTO() {
    return T_TIPO_BILANCIAMENTO;
  }
  public void set_T_TIPO_BILANCIAMENTO(String T_TIPO_BILANCIAMENTO) {
    this.T_TIPO_BILANCIAMENTO = T_TIPO_BILANCIAMENTO;
  }
  public RCUGAS_RCUGAS_BILANCIAMENTO with_T_TIPO_BILANCIAMENTO(String T_TIPO_BILANCIAMENTO) {
    this.T_TIPO_BILANCIAMENTO = T_TIPO_BILANCIAMENTO;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_D_DATA_INIZIO(String D_DATA_INIZIO) {
    this.D_DATA_INIZIO = D_DATA_INIZIO;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_D_DATA_FINE(String D_DATA_FINE) {
    this.D_DATA_FINE = D_DATA_FINE;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_T_NOTE(String T_NOTE) {
    this.T_NOTE = T_NOTE;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_D_AGGIORNAMENTO(String D_AGGIORNAMENTO) {
    this.D_AGGIORNAMENTO = D_AGGIORNAMENTO;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_N_ID_TRACCIA(java.math.BigDecimal N_ID_TRACCIA) {
    this.N_ID_TRACCIA = N_ID_TRACCIA;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_N_ID_S_PREC(java.math.BigDecimal N_ID_S_PREC) {
    this.N_ID_S_PREC = N_ID_S_PREC;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_BILANCIAMENTO with_D_DATA_RIF(String D_DATA_RIF) {
    this.D_DATA_RIF = D_DATA_RIF;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RCUGAS_RCUGAS_BILANCIAMENTO)) {
      return false;
    }
    RCUGAS_RCUGAS_BILANCIAMENTO that = (RCUGAS_RCUGAS_BILANCIAMENTO) o;
    boolean equal = true;
    equal = equal && (this.N_ID_BILANCIAMENTO == null ? that.N_ID_BILANCIAMENTO == null : this.N_ID_BILANCIAMENTO.equals(that.N_ID_BILANCIAMENTO));
    equal = equal && (this.N_ID_UDB == null ? that.N_ID_UDB == null : this.N_ID_UDB.equals(that.N_ID_UDB));
    equal = equal && (this.N_ID_PDR == null ? that.N_ID_PDR == null : this.N_ID_PDR.equals(that.N_ID_PDR));
    equal = equal && (this.T_TIPO_BILANCIAMENTO == null ? that.T_TIPO_BILANCIAMENTO == null : this.T_TIPO_BILANCIAMENTO.equals(that.T_TIPO_BILANCIAMENTO));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.N_ID_BILANCIAMENTO = JdbcWritableBridge.readBigDecimal(1, __dbResults);
    this.N_ID_UDB = JdbcWritableBridge.readBigDecimal(2, __dbResults);
    this.N_ID_PDR = JdbcWritableBridge.readBigDecimal(3, __dbResults);
    this.T_TIPO_BILANCIAMENTO = JdbcWritableBridge.readString(4, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeBigDecimal(N_ID_BILANCIAMENTO, 1 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_UDB, 2 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_PDR, 3 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(T_TIPO_BILANCIAMENTO, 4 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    if (__dataIn.readBoolean()) { 
        this.N_ID_BILANCIAMENTO = null;
    } else {
    this.N_ID_BILANCIAMENTO = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.N_ID_UDB = null;
    } else {
    this.N_ID_UDB = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.N_ID_PDR = null;
    } else {
    ...
    if (__dataIn.readBoolean()) { 
        this.T_TIPO_BILANCIAMENTO = null;
    } else {
    this.T_TIPO_BILANCIAMENTO = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    if (null == this.N_ID_BILANCIAMENTO) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.N_ID_BILANCIAMENTO, __dataOut);
    }
    if (null == this.N_ID_UDB) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.N_ID_UDB, __dataOut);
    }
    ...
    if (null == this.T_TIPO_BILANCIAMENTO) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, T_TIPO_BILANCIAMENTO);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(N_ID_BILANCIAMENTO==null?"\\N":N_ID_BILANCIAMENTO.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(N_ID_UDB==null?"\\N":N_ID_UDB.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(N_ID_PDR==null?"\\N":N_ID_PDR.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(T_TIPO_BILANCIAMENTO==null?"\\N":T_TIPO_BILANCIAMENTO, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.N_ID_BILANCIAMENTO = null; } else {
      this.N_ID_BILANCIAMENTO = new java.math.BigDecimal(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.N_ID_UDB = null; } else {
      this.N_ID_UDB = new java.math.BigDecimal(__cur_str);
    }
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.T_TIPO_BILANCIAMENTO = null; } else {
      this.T_TIPO_BILANCIAMENTO = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    RCUGAS_RCUGAS_BILANCIAMENTO o = (RCUGAS_RCUGAS_BILANCIAMENTO) super.clone();
    return o;
  }

  public void clone0(RCUGAS_RCUGAS_BILANCIAMENTO o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("N_ID_BILANCIAMENTO", this.N_ID_BILANCIAMENTO);
    __sqoop$field_map.put("N_ID_UDB", this.N_ID_UDB);
    __sqoop$field_map.put("N_ID_PDR", this.N_ID_PDR);
    __sqoop$field_map.put("T_TIPO_BILANCIAMENTO", this.T_TIPO_BILANCIAMENTO);
