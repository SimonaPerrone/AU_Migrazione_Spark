...
//
// Debug information:
// Generated date: Sat Jul 27 11:20:09 CEST 2019
...
public class rcu_rcu_udd extends SqoopRecord  implements DBWritable, Writable {
  ...
  public rcu_rcu_udd with_D_AGGIORNAMENTO(String D_AGGIORNAMENTO) {
    this.D_AGGIORNAMENTO = D_AGGIORNAMENTO;
    return this;
  }
  ...
  public rcu_rcu_udd with_D_INIZIO(String D_INIZIO) {
    this.D_INIZIO = D_INIZIO;
    return this;
  }
  ...
  public rcu_rcu_udd with_D_FINE(String D_FINE) {
    this.D_FINE = D_FINE;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.D_INIZIO = JdbcWritableBridge.readString(6, __dbResults);
    this.D_FINE = JdbcWritableBridge.readString(7, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(D_INIZIO, 6 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(D_FINE, 7 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.hiveStringReplaceDelims(T_CODICE_TERNA==null?"":T_CODICE_TERNA, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(N_ID_AZIENDA_RIF==null?"":N_ID_AZIENDA_RIF.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
