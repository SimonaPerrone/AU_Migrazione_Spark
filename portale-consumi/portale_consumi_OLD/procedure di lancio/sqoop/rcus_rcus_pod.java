// ORM class for table 'rcus.rcus_pod'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jul 27 13:13:33 CEST 2019
...
public class rcus_rcus_pod extends SqoopRecord  implements DBWritable, Writable {
  ...
  public rcus_rcus_pod with_N_ID_SCHEDA(java.math.BigDecimal N_ID_SCHEDA) {
    this.N_ID_SCHEDA = N_ID_SCHEDA;
    return this;
  }
  ...
  public rcus_rcus_pod with_N_ID_POD(java.math.BigDecimal N_ID_POD) {
    this.N_ID_POD = N_ID_POD;
    return this;
  }
  ...
  public rcus_rcus_pod with_T_CODICE_POD(String T_CODICE_POD) {
    this.T_CODICE_POD = T_CODICE_POD;
    return this;
  }
  ...
  public rcus_rcus_pod with_T_AREA_RIF(String T_AREA_RIF) {
    this.T_AREA_RIF = T_AREA_RIF;
    return this;
  }
  ...
  public rcus_rcus_pod with_B_RICH_INDENNIZZO(String B_RICH_INDENNIZZO) {
    this.B_RICH_INDENNIZZO = B_RICH_INDENNIZZO;
    return this;
  }
  ...
  public rcus_rcus_pod with_B_RICH_PREST_DISTR(String B_RICH_PREST_DISTR) {
    this.B_RICH_PREST_DISTR = B_RICH_PREST_DISTR;
    return this;
  }
  ...
  public rcus_rcus_pod with_N_ID_INDIRIZZO(java.math.BigDecimal N_ID_INDIRIZZO) {
    this.N_ID_INDIRIZZO = N_ID_INDIRIZZO;
    return this;
  }
  ...
  public rcus_rcus_pod with_T_NOTA(String T_NOTA) {
    this.T_NOTA = T_NOTA;
    return this;
  }
  ...
  public rcus_rcus_pod with_D_AGGIORNAMENTO(String D_AGGIORNAMENTO) {
    this.D_AGGIORNAMENTO = D_AGGIORNAMENTO;
    return this;
  }
  ...
  public rcus_rcus_pod with_D_ARCHIVIAZIONE(String D_ARCHIVIAZIONE) {
    this.D_ARCHIVIAZIONE = D_ARCHIVIAZIONE;
    return this;
  }
  ...
  public rcus_rcus_pod with_N_ID_TRACCIA(java.math.BigDecimal N_ID_TRACCIA) {
    this.N_ID_TRACCIA = N_ID_TRACCIA;
    return this;
  }
  ...
  public rcus_rcus_pod with_N_ID_S_PREC(java.math.BigDecimal N_ID_S_PREC) {
    this.N_ID_S_PREC = N_ID_S_PREC;
    return this;
  }
  ...
  public rcus_rcus_pod with_N_ID_S_SUCC(java.math.BigDecimal N_ID_S_SUCC) {
    this.N_ID_S_SUCC = N_ID_S_SUCC;
    return this;
  }
  ...
  public rcus_rcus_pod with_B_VALIDO(String B_VALIDO) {
    this.B_VALIDO = B_VALIDO;
    return this;
  }
  ...
  public rcus_rcus_pod with_N_ID_IND_FORN(java.math.BigDecimal N_ID_IND_FORN) {
    this.N_ID_IND_FORN = N_ID_IND_FORN;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof rcus_rcus_pod)) {
      return false;
    }
    rcus_rcus_pod that = (rcus_rcus_pod) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.T_CODICE_POD = JdbcWritableBridge.readString(3, __dbResults);
    this.T_AREA_RIF = JdbcWritableBridge.readString(4, __dbResults);
    this.B_RICH_INDENNIZZO = JdbcWritableBridge.readString(5, __dbResults);
    this.B_RICH_PREST_DISTR = JdbcWritableBridge.readString(6, __dbResults);
    this.N_ID_INDIRIZZO = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.T_NOTA = JdbcWritableBridge.readString(8, __dbResults);
    this.D_AGGIORNAMENTO = JdbcWritableBridge.readString(9, __dbResults);
    this.D_ARCHIVIAZIONE = JdbcWritableBridge.readString(10, __dbResults);
    ...
    this.N_ID_S_SUCC = JdbcWritableBridge.readBigDecimal(13, __dbResults);
    this.B_VALIDO = JdbcWritableBridge.readString(14, __dbResults);
    this.N_ID_IND_FORN = JdbcWritableBridge.readBigDecimal(15, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(T_CODICE_POD, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(T_AREA_RIF, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(B_RICH_INDENNIZZO, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(B_RICH_PREST_DISTR, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_INDIRIZZO, 7 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(T_NOTA, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(D_AGGIORNAMENTO, 9 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(D_ARCHIVIAZIONE, 10 + __off, 93, __dbStmt);
    ...
    JdbcWritableBridge.writeBigDecimal(N_ID_S_SUCC, 13 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(B_VALIDO, 14 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_IND_FORN, 15 + __off, 2, __dbStmt);
    return 15;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    rcus_rcus_pod o = (rcus_rcus_pod) super.clone();
    return o;
  }

  public void clone0(rcus_rcus_pod o) throws CloneNotSupportedException {
  }
