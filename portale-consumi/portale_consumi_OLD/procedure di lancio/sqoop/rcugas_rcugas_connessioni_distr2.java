// ORM class for table 'rcugas.rcugas_connessioni_distr2'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jul 27 11:33:00 CEST 2019
...
public class rcugas_rcugas_connessioni_distr2 extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("T_REMI_RCU", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T_REMI_RCU = (String)value;
      }
    });
    setters.put("ID_REGIONE_CLIMATICA", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        ID_REGIONE_CLIMATICA = (java.math.BigDecimal)value;
      }
    });
  }
  public rcugas_rcugas_connessioni_distr2() {
    init0();
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_T_CODICE_PDR(String T_CODICE_PDR) {
    this.T_CODICE_PDR = T_CODICE_PDR;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_N_ID_PDR(java.math.BigDecimal N_ID_PDR) {
    this.N_ID_PDR = N_ID_PDR;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_N_ID_REMI(java.math.BigDecimal N_ID_REMI) {
    this.N_ID_REMI = N_ID_REMI;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_D_DATA_INIZIO_CONN(String D_DATA_INIZIO_CONN) {
    this.D_DATA_INIZIO_CONN = D_DATA_INIZIO_CONN;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_D_DATA_FINE_CONN(String D_DATA_FINE_CONN) {
    this.D_DATA_FINE_CONN = D_DATA_FINE_CONN;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_T_REMI(String T_REMI) {
    this.T_REMI = T_REMI;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_N_ID_DISTR(java.math.BigDecimal N_ID_DISTR) {
    this.N_ID_DISTR = N_ID_DISTR;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_D_DATA_INIZIO_GESTECN(String D_DATA_INIZIO_GESTECN) {
    this.D_DATA_INIZIO_GESTECN = D_DATA_INIZIO_GESTECN;
    return this;
  }
  ...
  public rcugas_rcugas_connessioni_distr2 with_D_DATA_FINE_GESTECN(String D_DATA_FINE_GESTECN) {
    this.D_DATA_FINE_GESTECN = D_DATA_FINE_GESTECN;
    return this;
  }
  private String T_REMI_RCU;
  public String get_T_REMI_RCU() {
    return T_REMI_RCU;
  }
  public void set_T_REMI_RCU(String T_REMI_RCU) {
    this.T_REMI_RCU = T_REMI_RCU;
  }
  public rcugas_rcugas_connessioni_distr2 with_T_REMI_RCU(String T_REMI_RCU) {
    this.T_REMI_RCU = T_REMI_RCU;
    return this;
  }
  private java.math.BigDecimal ID_REGIONE_CLIMATICA;
  public java.math.BigDecimal get_ID_REGIONE_CLIMATICA() {
    return ID_REGIONE_CLIMATICA;
  }
  public void set_ID_REGIONE_CLIMATICA(java.math.BigDecimal ID_REGIONE_CLIMATICA) {
    this.ID_REGIONE_CLIMATICA = ID_REGIONE_CLIMATICA;
  }
  public rcugas_rcugas_connessioni_distr2 with_ID_REGIONE_CLIMATICA(java.math.BigDecimal ID_REGIONE_CLIMATICA) {
    this.ID_REGIONE_CLIMATICA = ID_REGIONE_CLIMATICA;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof rcugas_rcugas_connessioni_distr2)) {
      return false;
    }
    rcugas_rcugas_connessioni_distr2 that = (rcugas_rcugas_connessioni_distr2) o;
    boolean equal = true;
    ...
    equal = equal && (this.T_REMI_RCU == null ? that.T_REMI_RCU == null : this.T_REMI_RCU.equals(that.T_REMI_RCU));
    equal = equal && (this.ID_REGIONE_CLIMATICA == null ? that.ID_REGIONE_CLIMATICA == null : this.ID_REGIONE_CLIMATICA.equals(that.ID_REGIONE_CLIMATICA));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.T_REMI_RCU = JdbcWritableBridge.readString(10, __dbResults);
    this.ID_REGIONE_CLIMATICA = JdbcWritableBridge.readBigDecimal(11, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(T_REMI_RCU, 10 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(ID_REGIONE_CLIMATICA, 11 + __off, 2, __dbStmt);
    return 11;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.T_REMI_RCU = null;
    } else {
    this.T_REMI_RCU = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.ID_REGIONE_CLIMATICA = null;
    } else {
    this.ID_REGIONE_CLIMATICA = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.T_REMI_RCU) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, T_REMI_RCU);
    }
    if (null == this.ID_REGIONE_CLIMATICA) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.ID_REGIONE_CLIMATICA, __dataOut);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(T_REMI_RCU==null?"":T_REMI_RCU, " ", delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(ID_REGIONE_CLIMATICA==null?"":ID_REGIONE_CLIMATICA.toPlainString(), delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.T_REMI_RCU = null; } else {
      this.T_REMI_RCU = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.ID_REGIONE_CLIMATICA = null; } else {
      this.ID_REGIONE_CLIMATICA = new java.math.BigDecimal(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    rcugas_rcugas_connessioni_distr2 o = (rcugas_rcugas_connessioni_distr2) super.clone();
    return o;
  }

  public void clone0(rcugas_rcugas_connessioni_distr2 o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("T_REMI_RCU", this.T_REMI_RCU);
    __sqoop$field_map.put("ID_REGIONE_CLIMATICA", this.ID_REGIONE_CLIMATICA);
