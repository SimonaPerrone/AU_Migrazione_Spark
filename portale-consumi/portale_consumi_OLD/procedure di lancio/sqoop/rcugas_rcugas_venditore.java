// ORM class for table 'rcugas.rcugas_venditore'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jul 27 12:54:38 CEST 2019
...
public class rcugas_rcugas_venditore extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("T_CODICE_MAP", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T_CODICE_MAP = (String)value;
      }
    });
  ...
  public rcugas_rcugas_venditore() {
    init0();
  }
  ...
  public rcugas_rcugas_venditore with_N_ID_VENDITORE(java.math.BigDecimal N_ID_VENDITORE) {
    this.N_ID_VENDITORE = N_ID_VENDITORE;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_N_ID_AZIENDA(java.math.BigDecimal N_ID_AZIENDA) {
    this.N_ID_AZIENDA = N_ID_AZIENDA;
    return this;
  }
  private String T_CODICE_MAP;
  public String get_T_CODICE_MAP() {
    return T_CODICE_MAP;
  }
  public void set_T_CODICE_MAP(String T_CODICE_MAP) {
    this.T_CODICE_MAP = T_CODICE_MAP;
  }
  public rcugas_rcugas_venditore with_T_CODICE_MAP(String T_CODICE_MAP) {
    this.T_CODICE_MAP = T_CODICE_MAP;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_D_DATA_INIZIO(String D_DATA_INIZIO) {
    this.D_DATA_INIZIO = D_DATA_INIZIO;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_D_DATA_FINE(String D_DATA_FINE) {
    this.D_DATA_FINE = D_DATA_FINE;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_T_NOTE(String T_NOTE) {
    this.T_NOTE = T_NOTE;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_D_AGGIORNAMENTO(String D_AGGIORNAMENTO) {
    this.D_AGGIORNAMENTO = D_AGGIORNAMENTO;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_N_ID_TRACCIA(java.math.BigDecimal N_ID_TRACCIA) {
    this.N_ID_TRACCIA = N_ID_TRACCIA;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_N_ID_S_PREC(java.math.BigDecimal N_ID_S_PREC) {
    this.N_ID_S_PREC = N_ID_S_PREC;
    return this;
  }
  ...
  public rcugas_rcugas_venditore with_D_DATA_RIF(String D_DATA_RIF) {
    this.D_DATA_RIF = D_DATA_RIF;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof rcugas_rcugas_venditore)) {
      return false;
    }
    rcugas_rcugas_venditore that = (rcugas_rcugas_venditore) o;
    boolean equal = true;
    ...
    equal = equal && (this.T_CODICE_MAP == null ? that.T_CODICE_MAP == null : this.T_CODICE_MAP.equals(that.T_CODICE_MAP));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.N_ID_VENDITORE = JdbcWritableBridge.readBigDecimal(1, __dbResults);
    this.N_ID_AZIENDA = JdbcWritableBridge.readBigDecimal(2, __dbResults);
    this.T_CODICE_MAP = JdbcWritableBridge.readString(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeBigDecimal(N_ID_VENDITORE, 1 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_AZIENDA, 2 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(T_CODICE_MAP, 3 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.T_CODICE_MAP = null;
    } else {
    this.T_CODICE_MAP = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.T_CODICE_MAP) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, T_CODICE_MAP);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.hiveStringReplaceDelims(T_CODICE_MAP==null?"":T_CODICE_MAP, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.T_CODICE_MAP = null; } else {
      this.T_CODICE_MAP = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    rcugas_rcugas_venditore o = (rcugas_rcugas_venditore) super.clone();
    return o;
  }

  public void clone0(rcugas_rcugas_venditore o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("T_CODICE_MAP", this.T_CODICE_MAP);
