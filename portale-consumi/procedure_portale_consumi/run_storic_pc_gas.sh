...
then
 ...
 hdfs dfs -mkdir /user/hive/warehouse/misuregas.db/misure_storic_f2 >> "$LOG_FILE_STORIC"
 hdfs dfs -cp /user/hive/warehouse/acquirente_unico/misure.db/misure_storiche/storic_tmp_gas/* /user/hive/warehouse/misuregas.db/misure_storic_f2/ >> "$LOG_FILE_STORIC"
