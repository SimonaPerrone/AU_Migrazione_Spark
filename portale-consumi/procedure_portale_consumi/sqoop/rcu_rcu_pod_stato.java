// ORM class for table 'rcu.rcu_pod_stato'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jul 27 10:36:40 CEST 2019
...
public class rcu_rcu_pod_stato extends SqoopRecord  implements DBWritable, Writable {
  ...
  public rcu_rcu_pod_stato with_N_ID_POD(java.math.BigDecimal N_ID_POD) {
    this.N_ID_POD = N_ID_POD;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_STATO_ATTIVAZIONE(String T_STATO_ATTIVAZIONE) {
    this.T_STATO_ATTIVAZIONE = T_STATO_ATTIVAZIONE;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_D_ATTIVAZIONE(String D_ATTIVAZIONE) {
    this.D_ATTIVAZIONE = D_ATTIVAZIONE;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_D_DISATTIVAZIONE(String D_DISATTIVAZIONE) {
    this.D_DISATTIVAZIONE = D_DISATTIVAZIONE;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_CAUSALE_NO_RIATTIV(String T_CAUSALE_NO_RIATTIV) {
    this.T_CAUSALE_NO_RIATTIV = T_CAUSALE_NO_RIATTIV;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_CAUSALE_NO_DISATTIV(String T_CAUSALE_NO_DISATTIV) {
    this.T_CAUSALE_NO_DISATTIV = T_CAUSALE_NO_DISATTIV;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_STATO_SOSP(String T_STATO_SOSP) {
    this.T_STATO_SOSP = T_STATO_SOSP;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_D_SOSPENSIONE(String D_SOSPENSIONE) {
    this.D_SOSPENSIONE = D_SOSPENSIONE;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_D_REVOCA_SOSP(String D_REVOCA_SOSP) {
    this.D_REVOCA_SOSP = D_REVOCA_SOSP;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_CAUSALE_NO_SOSP(String T_CAUSALE_NO_SOSP) {
    this.T_CAUSALE_NO_SOSP = T_CAUSALE_NO_SOSP;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_SWITCHING(String T_SWITCHING) {
    this.T_SWITCHING = T_SWITCHING;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_NOTA(String T_NOTA) {
    this.T_NOTA = T_NOTA;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_D_AGGIORNAMENTO(String D_AGGIORNAMENTO) {
    this.D_AGGIORNAMENTO = D_AGGIORNAMENTO;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_N_ID_TRACCIA(java.math.BigDecimal N_ID_TRACCIA) {
    this.N_ID_TRACCIA = N_ID_TRACCIA;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_N_ID_S_PREC(java.math.BigDecimal N_ID_S_PREC) {
    this.N_ID_S_PREC = N_ID_S_PREC;
    return this;
  }
  ...
  public rcu_rcu_pod_stato with_T_COD_DISATTIVAZIONE(String T_COD_DISATTIVAZIONE) {
    this.T_COD_DISATTIVAZIONE = T_COD_DISATTIVAZIONE;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof rcu_rcu_pod_stato)) {
      return false;
    }
    rcu_rcu_pod_stato that = (rcu_rcu_pod_stato) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.T_STATO_ATTIVAZIONE = JdbcWritableBridge.readString(2, __dbResults);
    this.D_ATTIVAZIONE = JdbcWritableBridge.readString(3, __dbResults);
    this.D_DISATTIVAZIONE = JdbcWritableBridge.readString(4, __dbResults);
    this.T_CAUSALE_NO_RIATTIV = JdbcWritableBridge.readString(5, __dbResults);
    this.T_CAUSALE_NO_DISATTIV = JdbcWritableBridge.readString(6, __dbResults);
    this.T_STATO_SOSP = JdbcWritableBridge.readString(7, __dbResults);
    this.D_SOSPENSIONE = JdbcWritableBridge.readString(8, __dbResults);
    this.D_REVOCA_SOSP = JdbcWritableBridge.readString(9, __dbResults);
    this.T_CAUSALE_NO_SOSP = JdbcWritableBridge.readString(10, __dbResults);
    this.T_SWITCHING = JdbcWritableBridge.readString(11, __dbResults);
    this.T_NOTA = JdbcWritableBridge.readString(12, __dbResults);
    this.D_AGGIORNAMENTO = JdbcWritableBridge.readString(13, __dbResults);
    this.N_ID_TRACCIA = JdbcWritableBridge.readBigDecimal(14, __dbResults);
    this.N_ID_S_PREC = JdbcWritableBridge.readBigDecimal(15, __dbResults);
    this.T_COD_DISATTIVAZIONE = JdbcWritableBridge.readString(16, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(T_STATO_ATTIVAZIONE, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(D_ATTIVAZIONE, 3 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(D_DISATTIVAZIONE, 4 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(T_CAUSALE_NO_RIATTIV, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(T_CAUSALE_NO_DISATTIV, 6 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(T_STATO_SOSP, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(D_SOSPENSIONE, 8 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(D_REVOCA_SOSP, 9 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(T_CAUSALE_NO_SOSP, 10 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(T_SWITCHING, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(T_NOTA, 12 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(D_AGGIORNAMENTO, 13 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_TRACCIA, 14 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(N_ID_S_PREC, 15 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(T_COD_DISATTIVAZIONE, 16 + __off, 12, __dbStmt);
    return 16;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    rcu_rcu_pod_stato o = (rcu_rcu_pod_stato) super.clone();
    return o;
  }

  public void clone0(rcu_rcu_pod_stato o) throws CloneNotSupportedException {
  }
