// ORM class for table 'cmg.prt_cmg_rgl'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jul 27 08:17:19 CEST 2019
...
public class cmg_prt_cmg_rgl extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("MESE_COMP", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        MESE_COMP = (String)value;
      }
    });
    ...
    setters.put("PERIODO_RIC", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        PERIODO_RIC = (String)value;
      }
    });
  }
  public cmg_prt_cmg_rgl() {
    init0();
  }
  ...
  public cmg_prt_cmg_rgl with_N_ID(java.math.BigDecimal N_ID) {
    this.N_ID = N_ID;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_N_ID_FILE(java.math.BigDecimal N_ID_FILE) {
    this.N_ID_FILE = N_ID_FILE;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_ANNOMESE_RIFERIMENTO(String ANNOMESE_RIFERIMENTO) {
    this.ANNOMESE_RIFERIMENTO = ANNOMESE_RIFERIMENTO;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_DT_CARICAMENTO(String DT_CARICAMENTO) {
    this.DT_CARICAMENTO = DT_CARICAMENTO;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_COD_SERVIZIO(String COD_SERVIZIO) {
    this.COD_SERVIZIO = COD_SERVIZIO;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_COD_FLUSSO(String COD_FLUSSO) {
    this.COD_FLUSSO = COD_FLUSSO;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_PIVA_UTENTE(String PIVA_UTENTE) {
    this.PIVA_UTENTE = PIVA_UTENTE;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_PIVA_DISTR(String PIVA_DISTR) {
    this.PIVA_DISTR = PIVA_DISTR;
    return this;
  }
  private String MESE_COMP;
  public String get_MESE_COMP() {
    return MESE_COMP;
  }
  public void set_MESE_COMP(String MESE_COMP) {
    this.MESE_COMP = MESE_COMP;
  }
  public cmg_prt_cmg_rgl with_MESE_COMP(String MESE_COMP) {
    this.MESE_COMP = MESE_COMP;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_COD_PDR(String COD_PDR) {
    this.COD_PDR = COD_PDR;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_MATR_MIS(String MATR_MIS) {
    this.MATR_MIS = MATR_MIS;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_MATR_CONV(String MATR_CONV) {
    this.MATR_CONV = MATR_CONV;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_DATA_RACC(String DATA_RACC) {
    this.DATA_RACC = DATA_RACC;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_LET_TOT_PREL(String LET_TOT_PREL) {
    this.LET_TOT_PREL = LET_TOT_PREL;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_LET_TOT_CONV(String LET_TOT_CONV) {
    this.LET_TOT_CONV = LET_TOT_CONV;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_MOT_RETT_LETT(String MOT_RETT_LETT) {
    this.MOT_RETT_LETT = MOT_RETT_LETT;
    return this;
  }
  ...
  public cmg_prt_cmg_rgl with_VOL_RIC(java.math.BigDecimal VOL_RIC) {
    this.VOL_RIC = VOL_RIC;
    return this;
  }
  private String PERIODO_RIC;
  public String get_PERIODO_RIC() {
    return PERIODO_RIC;
  }
  public void set_PERIODO_RIC(String PERIODO_RIC) {
    this.PERIODO_RIC = PERIODO_RIC;
  }
  public cmg_prt_cmg_rgl with_PERIODO_RIC(String PERIODO_RIC) {
    this.PERIODO_RIC = PERIODO_RIC;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof cmg_prt_cmg_rgl)) {
      return false;
    }
    cmg_prt_cmg_rgl that = (cmg_prt_cmg_rgl) o;
    boolean equal = true;
    ...
    equal = equal && (this.MESE_COMP == null ? that.MESE_COMP == null : this.MESE_COMP.equals(that.MESE_COMP));
    ...
    equal = equal && (this.PERIODO_RIC == null ? that.PERIODO_RIC == null : this.PERIODO_RIC.equals(that.PERIODO_RIC));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.MESE_COMP = JdbcWritableBridge.readString(9, __dbResults);
    this.COD_PDR = JdbcWritableBridge.readString(10, __dbResults);
    this.MATR_MIS = JdbcWritableBridge.readString(11, __dbResults);
    this.MATR_CONV = JdbcWritableBridge.readString(12, __dbResults);
    this.DATA_RACC = JdbcWritableBridge.readString(13, __dbResults);
    this.LET_TOT_PREL = JdbcWritableBridge.readString(14, __dbResults);
    this.LET_TOT_CONV = JdbcWritableBridge.readString(15, __dbResults);
    this.MOT_RETT_LETT = JdbcWritableBridge.readString(16, __dbResults);
    this.VOL_RIC = JdbcWritableBridge.readBigDecimal(17, __dbResults);
    this.PERIODO_RIC = JdbcWritableBridge.readString(18, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(MESE_COMP, 9 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(COD_PDR, 10 + __off, 12, __dbStmt);
    ...
    JdbcWritableBridge.writeString(DATA_RACC, 13 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(LET_TOT_PREL, 14 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(LET_TOT_CONV, 15 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(MOT_RETT_LETT, 16 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(VOL_RIC, 17 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeString(PERIODO_RIC, 18 + __off, 12, __dbStmt);
    return 18;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.MESE_COMP = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.COD_PDR = null;
    } else {
    ...
    if (__dataIn.readBoolean()) { 
        this.PERIODO_RIC = null;
    } else {
    this.PERIODO_RIC = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.MESE_COMP) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, MESE_COMP);
    }
    ...
    if (null == this.PERIODO_RIC) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, PERIODO_RIC);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(MESE_COMP==null?"":MESE_COMP, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(PERIODO_RIC==null?"":PERIODO_RIC, " ", delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.MESE_COMP = null; } else {
      this.MESE_COMP = __cur_str;
    }
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.PERIODO_RIC = null; } else {
      this.PERIODO_RIC = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    cmg_prt_cmg_rgl o = (cmg_prt_cmg_rgl) super.clone();
    return o;
  }

  public void clone0(cmg_prt_cmg_rgl o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("MESE_COMP", this.MESE_COMP);
    ...
    __sqoop$field_map.put("PERIODO_RIC", this.PERIODO_RIC);
