// ORM class for table 'RCUGAS.RCUGAS_UDD'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Jan 30 07:11:35 CET 2021
...
public class RCUGAS_RCUGAS_UDD extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("T_COD_UDD", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        T_COD_UDD = (String)value;
      }
    });
  ...
  public RCUGAS_RCUGAS_UDD with_N_ID_UDD(java.math.BigDecimal N_ID_UDD) {
    this.N_ID_UDD = N_ID_UDD;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_N_ID_AZIENDA(java.math.BigDecimal N_ID_AZIENDA) {
    this.N_ID_AZIENDA = N_ID_AZIENDA;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_D_DATA_INIZIO(String D_DATA_INIZIO) {
    this.D_DATA_INIZIO = D_DATA_INIZIO;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_D_DATA_FINE(String D_DATA_FINE) {
    this.D_DATA_FINE = D_DATA_FINE;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_T_NOTE(String T_NOTE) {
    this.T_NOTE = T_NOTE;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_D_AGGIORNAMENTO(String D_AGGIORNAMENTO) {
    this.D_AGGIORNAMENTO = D_AGGIORNAMENTO;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_N_ID_TRACCIA(java.math.BigDecimal N_ID_TRACCIA) {
    this.N_ID_TRACCIA = N_ID_TRACCIA;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_N_ID_S_PREC(java.math.BigDecimal N_ID_S_PREC) {
    this.N_ID_S_PREC = N_ID_S_PREC;
    return this;
  }
  private String T_COD_UDD;
  public String get_T_COD_UDD() {
    return T_COD_UDD;
  }
  public void set_T_COD_UDD(String T_COD_UDD) {
    this.T_COD_UDD = T_COD_UDD;
  }
  public RCUGAS_RCUGAS_UDD with_T_COD_UDD(String T_COD_UDD) {
    this.T_COD_UDD = T_COD_UDD;
    return this;
  }
  ...
  public RCUGAS_RCUGAS_UDD with_D_DATA_RIF(String D_DATA_RIF) {
    this.D_DATA_RIF = D_DATA_RIF;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RCUGAS_RCUGAS_UDD)) {
      return false;
    }
    RCUGAS_RCUGAS_UDD that = (RCUGAS_RCUGAS_UDD) o;
    boolean equal = true;
    ...
    equal = equal && (this.T_COD_UDD == null ? that.T_COD_UDD == null : this.T_COD_UDD.equals(that.T_COD_UDD));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.D_DATA_INIZIO = JdbcWritableBridge.readString(3, __dbResults);
    this.D_DATA_FINE = JdbcWritableBridge.readString(4, __dbResults);
    ...
    this.T_COD_UDD = JdbcWritableBridge.readString(9, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(D_DATA_INIZIO, 3 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(D_DATA_FINE, 4 + __off, 93, __dbStmt);
    ...
    JdbcWritableBridge.writeString(T_COD_UDD, 9 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.T_COD_UDD = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.T_COD_UDD) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, T_COD_UDD);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(T_COD_UDD==null?"\\N":T_COD_UDD, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.T_COD_UDD = null; } else {
      this.T_COD_UDD = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    RCUGAS_RCUGAS_UDD o = (RCUGAS_RCUGAS_UDD) super.clone();
    return o;
  }

  public void clone0(RCUGAS_RCUGAS_UDD o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("T_COD_UDD", this.T_COD_UDD);
