...
MESE=$2
GIORNO=$3
#/mnt/isilonshare_gas/TMG_00010200186/DISTRIBUTORE/TMG_00010200186_10027190015/2018/1111/ElencoFileGiornalieri.txt
PATH_GAS="/mnt/isilonshare_gas/"
LOCAL_PATH="/home/acutest/GAS/bin/tools/reports/"
...
do
   ...
   find $PATH_GAS$i$filtro -type f | grep txt >> $file_report 
   find $PATH_GAS$i$filtro -type f  >> $file_report_all

done


path_hdf="/user/silvia/au/misure_gas_au/cmg_gas/report_listfiles_tmp"
...
hadoop fs -chown -R silvia $path_hdf
hadoop fs -chown -R silvia /user/silvia/au/misure_gas_au/cmg_gas/report_listfiles
