...
drop table sos_202011_202012.sw_misure_no_12m_202002 ;
create table sos_202011_202012.sw_misure_no_12m_202002 as

WITH bb AS
  ( SELECT ANNOMESE_SW,pod14,PIVA_DISTR,PIVA_UDD,TRATTAMENTO_ONLINE,t_cod_contr_disp as DP,tipo_misuratore_last  FROM sos_202011_202012.SW_CON_TRA_VIEW_RS X ---SWITCHING
...
FROM
  ...
  FROM au.flusso_misure_noaggr b
  INNER JOIN bb
...
--union all
--select * from sos_202011_202012.ingestion_orari; ---flussi orari