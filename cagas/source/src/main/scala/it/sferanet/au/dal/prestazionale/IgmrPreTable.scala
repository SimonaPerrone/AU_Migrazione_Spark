...
import it.sferanet.au.dal.prestazionale.IgmrPreTable._
import it.sferanet.au.model.prestazionale.IgmrPre
...
class IgmrPreTable(inputPath: String) extends Serializable {
      ...
      .flatMap(r => {
        ...
        if (Flow.getIsNewRouteVersion(r, newRouteField)) {
          List(IgmrPre(
            ...
            getOptionInt(IgmrPreTable.mot_ret_lett, r),
            getOptionDouble(IgmrPreTable.coefCorr, r),
            getOptionInt(IgmrPreTable.cau_int_mis, r), //cau_int_mis
            getOptionInt(IgmrPreTable.cau_int_cor, r), //cau_int_cor
...
object IgmrPreTable {
  ...
  def apply(inputPath: String): IgmrPreTable = new IgmrPreTable(inputPath)
  ...
  val schema = Flow.createSparkSchema(flowFields.getValues ::: List(readType, newRouteField, coefCorr, cau_int_mis, cau_int_cor, mot_ret_lett, partitioningColumn))
