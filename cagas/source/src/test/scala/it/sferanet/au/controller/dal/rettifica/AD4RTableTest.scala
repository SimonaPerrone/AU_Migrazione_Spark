...
import it.sferanet.au.dal.rettifica.AD4RTable
...
class AD4RTableTest extends EnvironmentSparkTest with Checker {
  ...
  def chekNew(obj: AD4R): Unit = {
    Assert.assertTrue(obj.service == "AD4R")
    Assert.assertTrue(obj.pdr == "02660000462866")
    Assert.assertTrue(dateFormat.format(obj.date.get) == "07/02/2019")
    Assert.assertTrue(obj.measure.get == 36.0)
    Assert.assertTrue(obj.converted.isEmpty)
    Assert.assertTrue(obj.serialNumberMis.get == "ITGF030102267500")
    Assert.assertTrue(obj.serialNumberConv.isEmpty)
    Assert.assertTrue(obj.local_file.get == "/mnt/isilonshare_gas/TMG_06724610966/DISTRIBUTORE/TMG_06724610966_08526440154/2021/0205/06724610966_08526440154_201902_AD4R_20210205131453_00_R.zip")
  ...
  def testAppOnlyNewRoute(): Unit = {
    ...
    val measures = AD4RTable("./src/test/resources/integrazione-ca/misure/ad4r/new_route").get()
    val obj: AD4R = measures.take(1)(0)
  ...
  def testFilterValidRows(): Unit = {
    ...
    val result1 = new AD4RTable(null).filterValidRows(rdd1)
    Assert.assertEquals(1, result1.count())

    val rdd2 = spark.sparkContext.parallelize(Seq(1)).map(r =>
      AD4R(motivation = Some(5),
        ammissibilita = None, service = null, pdr = null, date = null, pivaDistr = null, pivaUtente = null,
        measure = null, converted = null, serialNumberMis = null, serialNumberConv = null, local_file = null,
        d_caricamento = null, isNewRoute = false, raccolta = null)
    )
    val result2 = new AD4RTable(null).filterValidRows(rdd2)
    Assert.assertEquals(1, result2.count())

    val rdd3 = spark.sparkContext.parallelize(Seq(1)).map(r =>
      AD4R(motivation = Some(0),
        ammissibilita = None, service = null, pdr = null, date = null, pivaDistr = null, pivaUtente = null,
        measure = null, converted = null, serialNumberMis = null, serialNumberConv = null, local_file = null,
        d_caricamento = null, isNewRoute = false, raccolta = null)
    )
    val result3 = new AD4RTable(null).filterValidRows(rdd3)
    Assert.assertEquals(0, result3.count())

    val rdd4 = spark.sparkContext.parallelize(Seq(1)).map(r =>
      AD4R(motivation = Some(6),
        ammissibilita = None, service = null, pdr = null, date = null, pivaDistr = null, pivaUtente = null,
        measure = null, converted = null, serialNumberMis = null, serialNumberConv = null, local_file = null,
        d_caricamento = null, isNewRoute = false, raccolta = null)
    )
    val result4 = new AD4RTable(null).filterValidRows(rdd4)
