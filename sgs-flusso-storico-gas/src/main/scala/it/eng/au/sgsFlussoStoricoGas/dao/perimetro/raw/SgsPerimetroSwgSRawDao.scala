...
class SgsPerimetroSwgSRawDao extends PerimetroDao {
  override val tableName: String = Environment.getSgsDBName ++ "." ++ Environment.getPerimetroSwgSRawTableName
  override val tablePath: String = Environment.getPerimetroSwgSRawPath
