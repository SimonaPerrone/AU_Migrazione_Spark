...
class SgsPerimetroSwgARawDao extends PerimetroDao {
  override val tableName: String = Environment.getSgsDBName++"."++Environment.getPerimetroSwgARawTableName
  override val tablePath: String = Environment.getPerimetroSwgARawPath
