...
class SgsPerimetroUigSRawDao extends PerimetroDao {
  override val tableName: String = Environment.getSgsDBName++"."++Environment.getPerimetroUigSRawTableName
  override val tablePath: String = Environment.getPerimetroUigSRawPath
