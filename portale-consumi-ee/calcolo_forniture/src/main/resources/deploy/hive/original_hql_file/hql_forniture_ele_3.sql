...
select 
        ...
        join (select CAST(n_id_azienda AS STRING)n_id_azienda,t_rag_soc T_rag_soc,t_piva from rcu.rcu_azienda_p where isNumeric(n_id_azienda)=true ) AS  RCU_AZIENDA
