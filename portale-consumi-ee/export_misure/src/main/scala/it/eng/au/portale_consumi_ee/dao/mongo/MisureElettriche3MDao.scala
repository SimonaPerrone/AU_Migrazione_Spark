...
class MisureElettriche3MDao  extends MongoDbDao[MisureElettricheModel]{
  ...
  override val readConfig: ReadConfig = ReadConfig(Map(
    ...
    "collection" -> EnvironmentMisure.getProperty("mongodb.collection.misureElettriche3MNewSchema"),
