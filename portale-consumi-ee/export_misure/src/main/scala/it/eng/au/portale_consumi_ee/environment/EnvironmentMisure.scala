...
//
//class EnvironmentMisure (appName: String, propertiesPath: String, isLocal: Boolean,flow:String)
//  extends Environment(appName, propertiesPath, isLocal) {
//
//    override protected val sparkSession = if (isLocal) {
...
//
//  def getOrCreate(appName: String, path: String, isLocal: Boolean = false,flow:String): Unit =
//    property = new EnvironmentMisure(appName, path, isLocal,flow)
//
