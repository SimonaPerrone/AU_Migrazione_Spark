db.getCollection("${mongodb.collection.misureElettriche33M}").aggregate(
[
  {
    $project: {
      codice_fornitura: 1,
  ...
  {
    $merge: {
      into: "MisureElettriche33M_newSchema",
      whenMatched: "merge",
...
db.createCollection("${mongodb.collection.misureElettriche33MNewSchema}");

//add competenza_consumi as additional index
db.${mongodb.collection.misureElettriche33MNewSchema}.createIndex({competenza_consumi: -1 }) // Descending index on "age"