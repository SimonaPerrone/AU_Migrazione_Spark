...
import it.au.misure.eng.ammissibilita.pod.CheckAmmissibilitaPod.{filenameRegexSMIS, getXMLMetadataSMIS}
import it.au.misure.eng.args.AmmissibilitaParameters
import it.au.misure.eng.model.XMLMetadata
import it.au.misure.eng.schema.{RcuAziendaPSchema, RcuPodDistrPSchema, RcuPodPSchema, RcuUddPSchema, RcusPodDistrPSchema, RcusPodPSchema}
import it.au.misure.eng.utility.{Constants, SparkLocal, SystemUtility}
import junit.framework.TestCase
import it.au.misure.eng.ammissibilita.file.CheckAmmissibilitaFile.getRCUMaps
...
@Ignore
class TestCheckAmmissibilitaFileSMIS extends TestCase with SparkLocal {
