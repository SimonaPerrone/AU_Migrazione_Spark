...
object CdpRicUddAggregato extends CdpPdrElencoFlussi {
  ...
  override val keyFieldsConsumi: ListMap[String, String] = ListMap(
    ...
    piva -> CdpConsumptionRequestRunnableSchema.piva_udd.toString,
  ...
  override def fileSpecificFilterExpression: Column = col(CdpConsumptionRequestRunnableSchema.piva_udd).isNotNull and col(CdpConsumptionRequestRunnableSchema.idRichiesta).isNotNull and col(CdpConsumptionRequestRunnableSchema.anno_competenza).isNotNull
}
