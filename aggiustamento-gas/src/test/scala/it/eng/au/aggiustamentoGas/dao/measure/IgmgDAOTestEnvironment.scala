...
class IgmgDAOTestEnvironment extends EnvironmentSparkTest {
  def testGet(): Unit = {
    val result = new IgmgDAOMock().get("201906", "201909", getTreatment = false).cache
  ...
  class IgmgDAOMock extends IgmgDAO {
