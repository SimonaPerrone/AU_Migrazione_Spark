...
import it.eng.au.aggiustamentoGas.model.measure.A01
import it.eng.au.aggiustamentoGas.schema.measure.A01Schema
import it.eng.au.aggiustamentoGas.utility.environment.Environment
import org.apache.spark.sql.DataFrame
import org.junit.Assert

class A01DAOTestEnvironment extends EnvironmentSparkTest {

  def testGet(): Unit = {
    val result = A01DAOMock.get("201708", "202009", getTreatment = false).cache

    Assert.assertEquals(5, result.count)
    Assert.assertEquals(0, result.filter(_.service != "A01").count)
    ...
    Assert.assertEquals(Some('1'), result.filter(_.pdr == "2").first().asInstanceOf[A01].outcome)
    Assert.assertEquals(Some('1'), result.filter(_.pdr == "3").first().asInstanceOf[A01].outcome)
    Assert.assertEquals(Some('1'), result.filter(_.pdr == "4").first().asInstanceOf[A01].outcome)
    Assert.assertEquals(Some('1'), result.filter(_.pdr == "5").first().asInstanceOf[A01].outcome)
    Assert.assertFalse(result.filter(_.pdr == "6").first().outcome.isDefined)
  }

  object A01DAOMock extends A01DAO {
    override def readParquet: DataFrame = {
      val sqlContext = Environment.getSpark.sqlContext
      import sqlContext.implicits._
      List(
        ("A01", "1", "07/05/2020", "01/05/2021", "E", "000000706", "000081281", "000094011", "000095361", "0005559244", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A01.0150_20200530171817_397.xml", "", "",
          "", "2020-05-14T05:46:22.996999", "", "201706"),
        ("A01", "2", "15/04/2020", "01/05/2021", "E", "000000706", "000081281", "null", "null", "0000486011", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A01.0150_20200530171817_397.xml", "", "",
          "", "2020-04-24T04:00:51.369432", "1", "202001"),
        ("A01", "3", "28/04/2020", null, "E", "000000706", "000081281", "000000710", "000081282", "0055329616", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A01.0150_20200530171817_397.xml", "", "",
          "", "2020-05-06T05:17:03.890467", "1", "202001"),
        ("A01", "4", "NULL", "18/08/2020", "E", "null", "null", "000000710", "000081282", "0005851658", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A01.0150_20200530171817_397.xml", "", "",
          "", "2020-08-25T08:51:22.887217", "1", "202001"),
        ("A01", "5", "02/01/2020", "01/05/2021", "E", "000000706", "000081281", "000094011", "null", "0084866499", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A01.0150_20200530171817_397.xml", "", "",
          "", "2020-05-12T21:15:58.590415", "1", "202001"),
        ("A01", "6", "", "", "E", "", "", "null", "null", "0032520730", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A01.0150_20200530171817_397.xml", "", "",
