...
class Ad4DAOTestEnvironment extends EnvironmentSparkTest {

  def testGet(): Unit = {
    val result = Ad4DAOMock.get("201708", "202009", getTreatment = false).cache
  ...
  object Ad4DAOMock extends Ad4DAO {
