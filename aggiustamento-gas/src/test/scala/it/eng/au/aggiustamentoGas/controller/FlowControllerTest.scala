...
import it.eng.au.aggiustamentoGas.dao.measure.{A01DAO, IgmgDAO, Im1DAO, MeasureDAO, RglDAO, RmlDAO, TglDAO}
...
class FlowControllerTest extends EnvironmentSparkTest {
  def testGet(): Unit = {
    ...
    val result = new FlowControllerMock(new ExclusionFilterController(isStrong = false), new ExclusionFilterController(isStrong = true), List():List[InclusionFilterController])
  ...
  def testIntegrationIncludeFilterController(): Unit = {
    ...
    val conn2DistrDF =  Environment.getSpark.sparkContext.parallelize(
      List(
        ("1", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "id2"),
        ("2", "2021-05-11 00:00:00.0", "2021-06-10 00:00:00.0", "2021-05-11 00:00:00.0", "2021-06-10 00:00:00.0", "id1"),
        ("2", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "id3"),
        ("3", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "2021-06-11 00:00:00.0", "id1")
      )
    ).toDF(
    ...
    val result = new FlowControllerMock(new ExclusionFilterController(isStrong = false), new ExclusionFilterController(isStrong = true), InclusionFilterController.getFilter(rcuGasMassivo, conn2DistrDF))
      .getAllOtherMeasures("202101", "202101", getTreatment = false).cache
  ...
  class FlowControllerMock(
                          ...
                          ) extends FlowController(exclusionFilterController, strongExclusionFilterController, inclusionFilters) {
  ...
  class RglDAOMock extends RglDAO {
    override def get(startDate: String, endDate: String, getTreatment: Boolean): RDD[Flow] = {
      val file2exclude = Some("/mnt/isilonshare1/GAS_INJ/TMG_0/DISTRIBUTORE/TMG_0_1/2020/0110/0_1_201912_TGL0050_20200109151501_1.xml")
  ...
  def testRemoveDuplicates(): Unit = {
    ...
    Assert.assertEquals(2, result.filter(_.pdr.equals("pdr1")).count())
  ...
  class FlowControllerDuplicatesMock(
    ...
    // Case 4: the remaining flows are grouped by localFile, and everything but dCaricamento is checked. Then the most recent flow is chosen. Result => 2 flows (the last one)
