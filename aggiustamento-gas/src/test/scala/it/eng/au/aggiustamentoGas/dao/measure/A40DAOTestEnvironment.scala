...
import it.eng.au.aggiustamentoGas.model.measure.A40
import it.eng.au.aggiustamentoGas.schema.measure.A40Schema
import it.eng.au.aggiustamentoGas.utility.environment.Environment
import org.apache.spark.sql.DataFrame
import org.junit.Assert

class A40DAOTestEnvironment extends EnvironmentSparkTest {
  ...
  object A40DAOMock extends A40DAO {
    override def readParquet: DataFrame = {
      ...
      List(
        ...
        ("A40", "2", "15/04/2020", "01/05/2021", "S", "000000706", "000081281", "null", "null", "0000486011", "null",
        ...
        ("A40", "3", "28/04/2020", null, "S", "000000706", "000081281", "000000710", "000081282", "0055329616", "null",
          "/mnt/isilonshare1/GAS_INJ/TMG_03757660968/DISTRIBUTORE/TMG_03757660968_03757680966/2020/0611/03757660968_03757680966_A40.0150_20200530171817_397.xml", null, "",
