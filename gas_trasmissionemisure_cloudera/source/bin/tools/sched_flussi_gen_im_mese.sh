...
BASEPATH="/home/sii_misure_gas/GAS/bin/"
BASEPATH_LOG="/home/sii_misure_gas/GAS/log"
CURDD=`date +%Y-%m-%d`
...
echo "./flusso-misure.sh -DGAS ${FLUSSO} --anno ${ANNO} --mese ${MESE} --giorni ${GIORNO}"  &>> ${LOG_FILE}
echo "./flusso-misure.sh -DGAS ${FLUSSO} --anno ${ANNO} --mese ${MESE} --giorni ${GIORNO}"
