...
#SCHEMAS_DIR = "/mnt/isilonshare1/XSD_GAS/schemas/" #os.path.join(os.path.dirname(__file__), 'schemas/')
#SCHEMAS_DIR = "/mnt/share/data/GAS/XSD/schemas/" #os.path.join(os.path.dirname(__file__), 'schemas/')
SCHEMAS_DIR = constants.XSD_HOME_PATH  #os.path.join(os.path.dirname(__file__), 'schemas/')
