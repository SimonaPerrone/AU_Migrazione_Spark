...
class FlussoA01_0150:
    def __init__(self):
        self.XSD_SCHEMAS_DIR = "file:///mnt/isilonshare1/XSD_GAS/"
        self.PATH_HDFS = "/user/hive/warehouse/au.db/misure_gas_au/cmg_gas/prt_cmg_a01_0150_p"
        self.CMD_REFRESH = "MSCK REPAIR TABLE cmg_gas.prt_cmg_A01_0150_p"

    def getCodFlusso(self):
        return "A01_0150"

    def get_xsd_file(self, flusso):
        FILE_XSD = os.path.join(self.XSD_SCHEMAS_DIR, 'A/A01_0150.xsd')
        return FILE_XSD
