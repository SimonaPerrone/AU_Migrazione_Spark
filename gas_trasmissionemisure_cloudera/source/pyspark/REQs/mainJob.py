...
def main(argv):
    ...
    #Debug
    #listFiles = ["/mnt/Settlement/TSG/TSG1/TSG1_03916040656/2020/06/03916040656_TDS_202006_01.csv", "/mnt/Settlement/TSG/TSG1/TSG1_00821860947/2020/06/00821860947_TDS_202006_001.csv"]
    ...
    for f in listFiles:
        ...
        if (result_validazione_file):
            ...
            list_valid_record_bad.append(("200", "Il file non rispetta la struttura prevista - Nome del file non conforme", f, 0))
    ...
    print ("Lista file elaborare: {}".format(listElaborate))
    ...
    # Versione Prod
    dataframe_KO.write.parquet('/user/acutest/au/misure_gas_au/ANOM_TMP', 'overwrite')
    dataframe_OK.write.parquet('/user/acutest/au/misure_gas_au/AMM_TMP', 'overwrite')
    ...
    function.repair_table(sqlCtx, "au_test.ANOM_TMP")
    function.repair_table(sqlCtx, "au_test.AMM_TMP")
    ...
    rcugas_massivo_dataframe, dataframe_rcuazienda, rcugas_connessioni_distr, rcugas_tmp_va1 = function.load_tables(sqlCtx)
    ...
    print ("check extra")
    time1 = time.time()
    dataframe_OK, dataframe_KO_extra = function.extra(sqlCtx, dataframe_OK, rcugas_massivo_dataframe, rcugas_connessioni_distr, rcugas_tmp_va1)
