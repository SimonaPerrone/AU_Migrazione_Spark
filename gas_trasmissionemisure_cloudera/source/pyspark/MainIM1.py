...
from CommandIM1 import Command
...
def usage():
    ...
    print('--anno: Anno')
    print('--mese: Mese')
    print('-d oppure --distr: distributore')
    print('Esempio:')
    print('Avviare modalita ingestion:')
    print('     ./ingestion_data -i /mnt/isilonshare_gas/')
    print('')
    ...
    print('--mese: Mese; <MM>')
    print('--anno: Anno; <AA>')
    print('-d oppure --distr: Codice distributore')
    print('Esempio:')
    print('Avviare modalita decompres:')
    print('     ./unzip_data -i /mnt/isilonshare_gas/ --anno 2019 --mese 02 -d TMP_123456789')
    print('')
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "hvi:zm:sc:f:e:d:",
                                   ["input=", "zip=", "mode=", "profstd=", "calculate=", "dateStart=", "dateEnd=",
                                    "flusso=", "file=", "giorno=", "anno=", "mese=", "distr="])
