...
class UddPdrDettaglioUnicoTest extends EnvironmentSparkTest {
  def testAggregato(): Unit = {
    ...
    val dailyConsumptionDF = Environment.sparkContext.parallelize(
      List(
        ...
        (date, 0.5, 1.0, 10, true, "G", "202012", "000PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "Y", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "S_AGG_1"),
        (date, 0.2, 1.0, 11, true, "G", "202012", "001PDR", "001DISTR", "000IT", "000UDD", "000UDB", "000RDB", "Y", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "S_AGG_1"),
        (date, 0.1, 1.0, 0, true, "G", "202012", "001PDR", "001DISTR", "000IT", "000UDD", "000UDB", "000RDB", "Y", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "S_AGG_1"),
    ...
    val aggDF = UddPdrDettaglioUnico.getAggregato(dailyConsumptionDF).persist()
    aggDF.show()
    ...
    val csvFields = UddPdrDettaglioUnico.getCsvFields(aggDF)
