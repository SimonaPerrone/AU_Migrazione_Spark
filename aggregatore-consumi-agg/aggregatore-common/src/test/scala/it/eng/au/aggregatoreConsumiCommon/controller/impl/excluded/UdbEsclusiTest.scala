...
class UdbEsclusiTest extends EnvironmentSparkTest {
  /*def testGetAggregato(): Unit = {
    ...
    val dailyConsumptionDF = Environment.sparkContext.parallelize(
      (1 to 31)
        .map(i => (6, true, "N", "202001", "000PDR", "000DIST", "000IT", "000UDD", "000UDB", "000RDB", "Y", "000REMI", 0.1, 1.0, "000IDCL", "CODPROF_0", "U", "T", "S_AGG_1"))
        ++
        List(
          (0, true, "N", "202001", "001PDR", "000DIST", "000IT", "000UDD", "000UDB", "000RDB", "Y", "000REMI", 0.1, 1.0, "000IDCL", "CODPROF_0", "U", "T", "S_AGG_1"),
          (0, false, null, "202001", "000PDR", "000DIST", "000IT", "000UDD", "000UDB", "000RDB", "Y", "000REMI", 0.1, 1.0, "000IDCL", "CODPROF_0", "U", "T", "S_AGG_1")
        )
    ).toDF(
    ...
    val outDF = UdbEsclusi.getAggregato(dailyConsumptionDF)
