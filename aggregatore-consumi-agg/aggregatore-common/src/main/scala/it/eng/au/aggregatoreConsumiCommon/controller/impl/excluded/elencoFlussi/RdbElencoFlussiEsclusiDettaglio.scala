...
object RdbElencoFlussiEsclusiDettaglio extends ElencoFlussiDettaglioEsclusi {
  ...
  override def getCsvOutputPath(baseName: String, piva1: String, piva2: String, annomese: String, sessionName: String, date: LocalDateTime, counterCsv: String): String = {
    ...
    s"/${baseName}_$piva1/$year/$month/${piva1}_AGG_${operationName}_${annomese}_ElencoFlussi_${timestamp}_${counterCsv}.csv"
  }
}
