...
object UddDettaglioG extends DettaglioGTrait {
  override val baseNumber: String = "1"
  override val keyFields: List[String] = List(DettaglioGOutputSchema.piva_udd.toString, DettaglioGOutputSchema.piva_distr.toString)
