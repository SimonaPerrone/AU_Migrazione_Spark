...
class RdbIncoerentiDettaglioSbgTest extends EnvironmentSparkTest {
  def testGetAggregato(): Unit = {
    ...
    val dailyConsumptionDF = Environment.sparkContext.parallelize(
      List(
        (java.sql.Date.valueOf("2020-12-11"), 1.0, 1.5, 100000.1, 0, true, "G", "000PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012"),
        (java.sql.Date.valueOf("2020-12-12"), 1.0, 1.5, 100000.1, 0, true, "G", "000PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012"),
        (java.sql.Date.valueOf("2020-12-13"), 1.0, 1.5, 0.5, 0, true, "N", "000PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G2,5", "202012"),
        (java.sql.Date.valueOf("2020-12-14"), 1.0, 1.5, 2.0, 0, true, "G", "000PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G4", "202012"),
        (java.sql.Date.valueOf("2020-12-15"), 1.0, 1.5, 0.1, 10, true, "G", "000PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G60", "202012"),
        (java.sql.Date.valueOf("2020-12-16"), 1.0, 1.5, 0.1, 10, true, "G", "001PDR", "000DISTR", "000IT", "000UDD", "000UDB", "001RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012"),
        (java.sql.Date.valueOf("2020-12-17"), 1.0, 1.5, 100000.1, 10, true, "G", "001PDR", "000DISTR", "000IT", "000UDD", "000UDB", "001RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012"),
        (java.sql.Date.valueOf("2020-12-18"), 1.0, 1.5, 100000.1, 10, true, "G", "002PDR", "000DISTR", "000IT", "000UDD", "000UDB", "001RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012"),
        (java.sql.Date.valueOf("2020-12-19"), 1.0, 1.5, 100000.1, 10, true, "G", "002PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012"),
        (java.sql.Date.valueOf("2020-12-19"), 1.0, 1.5, 100000.1, 10, true, "G", "002PDR", "000DISTR", "000IT", "000UDD", "000UDB", "000RDB", "000REMI", 0.1, "000IDCL", "CODPROF_0", "U", "T", "G1,6", "202012")
      )
    ).toDF(
    ...
    val anomalousPdrs = RdbIncoerentiDettaglioSbg.getAnomalousPdrs(dailyConsumptionDF)
    val outDF = RdbPdrIncoerentiDettaglio.getAggregatoFromPdrs(anomalousPdrs)

    outDF.show

    //RdbIncoerentiDettaglioSbg.run(dailyConsumptionDF)
    ...
    //Assert.assertEquals(1, outDF.filter(col("prelievo_non_sterilizzato_giorn_12") === lit(100000)).count)
