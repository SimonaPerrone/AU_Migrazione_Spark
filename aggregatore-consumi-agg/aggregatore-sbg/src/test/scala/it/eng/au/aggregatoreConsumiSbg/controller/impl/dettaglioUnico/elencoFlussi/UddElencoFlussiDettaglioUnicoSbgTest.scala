...
class UddElencoFlussiDettaglioUnicoSbgTest extends EnvironmentSparkTest with ElencoFlussiDettaglioUnicoSbg {
  def testAggregato(): Unit = {
    ...
    val csvFields = UddElencoFlussiDettaglioUnicoSbg.getCsvFields(aggDF)
