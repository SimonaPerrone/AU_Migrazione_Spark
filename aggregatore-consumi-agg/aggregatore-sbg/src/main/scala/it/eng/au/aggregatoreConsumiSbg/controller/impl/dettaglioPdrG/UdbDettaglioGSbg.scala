...
object UdbDettaglioGSbg extends DettaglioGTraitSbg {
  override val baseNumber: String = "5"
  override val keyFields: List[String] = List(DettaglioGOutputSchema.piva_udb.toString, DettaglioGOutputSchema.piva_udd.toString)
