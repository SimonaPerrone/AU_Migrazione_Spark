...
object UdbElencoFlussiDettaglioDeltaNegativoSbg extends ElencoFlussiDettaglioDeltaNegativoSbg {
  override val baseNumber: String = "5"
  override val keyPiva1: String = DeltaNegativoElencoFlussiSchema.piva_udb
