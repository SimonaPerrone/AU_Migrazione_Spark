...
import it.eng.au.aggregatoreConsumiSbg.controller.impl.incoerenti.confNoConf.IDIncoerentiConfNoConf
...
trait IDIncoerentiTraitSbg extends IncoerentiTraitSbg {
  override val baseNumber: String = "4"
  override val incoerentiConfNoConf: IncoerentiConfNoConfTraitSbg = IDIncoerentiConfNoConf
  override def fileSpecificFilterExpression: Column = lit(true)

  override val keyFields: List[String] = List(IncoerentiOutputSchema.piva_distr)
