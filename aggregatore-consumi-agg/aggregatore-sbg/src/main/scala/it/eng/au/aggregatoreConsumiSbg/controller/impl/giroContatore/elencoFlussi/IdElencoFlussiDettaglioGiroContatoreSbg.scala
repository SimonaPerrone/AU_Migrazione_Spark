...
object IdElencoFlussiDettaglioGiroContatoreSbg extends ElencoFlussiDettaglioGiroContatoreSbg {
  override val baseNumber: String = "4"
  override val keyPiva1: String = GiroContatoreElencoFlussiSchema.piva_distr
  override val keyPiva2: String = GiroContatoreElencoFlussiSchema.piva_udd
