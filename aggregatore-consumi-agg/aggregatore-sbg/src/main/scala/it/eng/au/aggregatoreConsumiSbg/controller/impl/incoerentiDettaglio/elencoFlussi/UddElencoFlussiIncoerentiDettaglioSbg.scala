...
object UddElencoFlussiIncoerentiDettaglioSbg extends ElencoFlussiDettaglioIncoerentiSbg {
  ...
  override val csvFields: List[String] = aggregatoColumns.values.toList.diff(List(IncoerentiDettaglioSchema.piva_udd))
