...
object IdPdrDettaglioUnicoSbg extends PdrDettaglioUnicoSbg {
  override val baseNumber: String = "4"
  //  override val keyFields: List[String] = List(DettaglioUnicoSchema.piva_distr, DettaglioUnicoSchema.piva_udd)
