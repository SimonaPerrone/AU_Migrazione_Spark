...
object UdbElencoFlussiDettaglioGiroContatoreSbg extends ElencoFlussiDettaglioGiroContatoreSbg {
  override val baseNumber: String = "5"
  override val keyPiva1: String = GiroContatoreElencoFlussiSchema.piva_udb
