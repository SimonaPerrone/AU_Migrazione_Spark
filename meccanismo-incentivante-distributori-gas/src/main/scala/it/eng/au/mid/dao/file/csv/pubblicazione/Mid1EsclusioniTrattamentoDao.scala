...
class Mid1EsclusioniTrattamentoDao extends CsvDao[MidEsclusioniTrattamentoModel] {
  override val path: String = Environment.getProperty("file.path.mid1_esclusioni_tratt")
