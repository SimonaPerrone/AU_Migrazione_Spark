...
class Mid1EsclusioniDistributoreDao extends CsvDao[MidEsclusioniDistributoreModel] {
  override val path: String = Environment.getProperty("file.path.mid1_esclusioni_distr")
